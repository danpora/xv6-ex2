      ...
      1b:	0f 8f c3 00 00 00    	jg     e4 <main+0xe4>
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      40:	80 3d 42 1f 00 00 20 	cmpb   $0x20,0x1f42
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
      ...
      6a:	6a 64                	push   $0x64
      6c:	68 40 1f 00 00       	push   $0x1f40
      71:	e8 9a 00 00 00       	call   110 <getcmd>
      76:	83 c4 10             	add    $0x10,%esp
      79:	85 c0                	test   %eax,%eax
      7b:	78 78                	js     f5 <main+0xf5>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      7d:	80 3d 40 1f 00 00 63 	cmpb   $0x63,0x1f40
      84:	75 ca                	jne    50 <main+0x50>
      86:	80 3d 41 1f 00 00 64 	cmpb   $0x64,0x1f41
...
fork1(void)
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      a9:	68 40 1f 00 00       	push   $0x1f40
      ae:	e8 ad 0a 00 00       	call   b60 <strlen>
      if(chdir(buf+3) < 0)
      b3:	c7 04 24 43 1f 00 00 	movl   $0x1f43,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      // Chdir must be called by the parent, not the child.
      buf[strlen(buf)-1] = 0;  // chop \n
      ba:	c6 80 3f 1f 00 00 00 	movb   $0x0,0x1f3f(%eax)
      if(chdir(buf+3) < 0)
      ...
      cb:	79 9a                	jns    67 <main+0x67>
        printf(2, "cannot cd %s\n", buf+3);
      cd:	50                   	push   %eax
      ce:	68 43 1f 00 00       	push   $0x1f43
      d3:	68 35 17 00 00       	push   $0x1735
      d8:	6a 02                	push   $0x2
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
     ...
     11e:	68 8c 16 00 00       	push   $0x168c
     123:	6a 02                	push   $0x2
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 29 17 00 00       	push   $0x1729
     16e:	6a 02                	push   $0x2
...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 44 17 00 00 	jmp    *0x1744(,%eax,4)
    runcmd(lcmd->right);
    break;
...
fork1(void)
{
  ...
  case EXEC:
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     236:	68 96 16 00 00       	push   $0x1696
     23b:	6a 02                	push   $0x2
...
fork1(void)
{
  ...
  default:
    panic("runcmd");
     ...
     292:	68 8f 16 00 00       	push   $0x168f
     297:	e8 c4 fe ff ff       	call   160 <panic>
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     29f:	68 b6 16 00 00       	push   $0x16b6
  ...
  case REDIR:
    ...
    if(open(rcmd->file, rcmd->mode) < 0){
     ...
     2ad:	68 a6 16 00 00       	push   $0x16a6
     2b2:	6a 02                	push   $0x2
  ...
  case PIPE:
    ...
    if(pipe(p) < 0)
     ...
     2c1:	68 bb 16 00 00       	push   $0x16bb
     ...
     341:	c3                   	ret    
{
  ...
  if(pid == -1)
    panic("fork");
     ...
     345:	68 b6 16 00 00       	push   $0x16b6
     ...
     4a0:	83 c7 01             	add    $0x1,%edi
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4b1:	50                   	push   %eax
     4b2:	68 1c 1f 00 00       	push   $0x1f1c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     505:	50                   	push   %eax
     506:	68 1c 1f 00 00       	push   $0x1f1c
  ...
  *ps = s;
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     556:	50                   	push   %eax
     557:	68 14 1f 00 00       	push   $0x1f14
  ...
  default:
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     575:	50                   	push   %eax
     576:	68 1c 1f 00 00       	push   $0x1f1c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     61d:	50                   	push   %eax
     61e:	68 1c 1f 00 00       	push   $0x1f1c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 dd 16 00 00       	push   $0x16dd
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  while(peek(ps, es, "<>")){
    ...
    if(gettoken(ps, es, &q, &eq) != 'a')
     ...
     6fe:	68 c0 16 00 00       	push   $0x16c0
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 e0 16 00 00       	push   $0x16e0
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     776:	68 f7 16 00 00       	push   $0x16f7
     77b:	57                   	push   %edi
     77c:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     7c2:	68 e9 16 00 00       	push   $0x16e9
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(tok != 'a')
     ...
     80d:	68 e2 16 00 00       	push   $0x16e2
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
     83b:	68 fc 16 00 00       	push   $0x16fc
     840:	56                   	push   %esi
     841:	53                   	push   %ebx
...
parseline(char **ps, char *es)
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 fe 16 00 00       	push   $0x16fe
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 fa 16 00 00       	push   $0x16fa
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 e0 16 00 00       	push   $0x16e0
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     96b:	68 1c 17 00 00       	push   $0x171c
     970:	56                   	push   %esi
     971:	53                   	push   %ebx
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    panic("parseblock");
     ...
     99f:	68 00 17 00 00       	push   $0x1700
  ...
  if(!peek(ps, es, ")"))
    panic("syntax - missing )");
     ...
     9ac:	68 0b 17 00 00       	push   $0x170b
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d9:	ff 24 85 5c 17 00 00 	jmp    *0x175c(,%eax,4)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 fd 17 00 00       	push   $0x17fd
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  if(s != es){
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 1e 17 00 00       	push   $0x171e
     ac6:	6a 02                	push   $0x2
     ac8:	e8 c3 03 00 00       	call   e90 <printf>
    panic("syntax");
     acd:	c7 04 24 e2 16 00 00 	movl   $0x16e2,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     e2f:	f7 f6                	div    %esi
     e31:	0f b6 92 7c 17 00 00 	movzbl 0x177c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fa8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
     fab:	b8 74 17 00 00       	mov    $0x1774,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1031:	a1 a4 1f 00 00       	mov    0x1fa4,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    1089:	a3 a4 1f 00 00       	mov    %eax,0x1fa4
}
    108e:	5b                   	pop    %ebx
    108f:	5e                   	pop    %esi
    1090:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    10ad:	a3 a4 1f 00 00       	mov    %eax,0x1fa4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    10cc:	8b 15 a4 1f 00 00    	mov    0x1fa4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1121:	39 05 a4 1f 00 00    	cmp    %eax,0x1fa4
  ...
  return freep;
    114b:	8b 15 a4 1f 00 00    	mov    0x1fa4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    116c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    116f:	89 15 a4 1f 00 00    	mov    %edx,0x1fa4
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    1186:	c7 05 a4 1f 00 00 a8 	movl   $0x1fa8,0x1fa4
    118d:	1f 00 00 
    1190:	c7 05 a8 1f 00 00 a8 	movl   $0x1fa8,0x1fa8
    1197:	1f 00 00 
    base.s.size = 0;
    119a:	b8 a8 1f 00 00       	mov    $0x1fa8,%eax
    119f:	c7 05 ac 1f 00 00 00 	movl   $0x0,0x1fac
    11a6:	00 00 00 
    11a9:	e9 3e ff ff ff       	jmp    10ec <malloc+0x2c>
    11ae:	66 90                	xchg   %ax,%ax

000011b0 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
    ...
    11b4:	56                   	push   %esi
    11b5:	53                   	push   %ebx
    11b6:	83 ec 28             	sub    $0x28,%esp
  // switch alarm(0) to cancel thread switching while yielding 
  alarm(0);
    11b9:	6a 00                	push   $0x0
    11bb:	e8 1a fc ff ff       	call   dda <alarm>
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    11c0:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    11c5:	83 c4 10             	add    $0x10,%esp
    11c8:	8d 14 40             	lea    (%eax,%eax,2),%edx
    11cb:	8d 14 d5 e0 1f 00 00 	lea    0x1fe0(,%edx,8),%edx
    11d2:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
    11d6:	0f 84 54 01 00 00    	je     1330 <uthread_yield+0x180>
  ...
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
    11dc:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
    11df:	83 05 c0 1f 00 00 01 	addl   $0x1,0x1fc0
    11e6:	bb f0 1f 00 00       	mov    $0x1ff0,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
    11eb:	89 e2                	mov    %esp,%edx
    11ed:	8d 04 c5 e0 1f 00 00 	lea    0x1fe0(,%eax,8),%eax
  ...
  current_ticket_num = -1;
    11f4:	c7 05 90 20 00 00 ff 	movl   $0xffffffff,0x2090
    11fb:	ff ff ff 
    11fe:	89 de                	mov    %ebx,%esi
    1200:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
    1204:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    1209:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
    120e:	89 50 04             	mov    %edx,0x4(%eax)
  asm("movl %%ebp, %0;" : "=r" (uthread_pool[c_uthread_index].ebp));
    1211:	89 ea                	mov    %ebp,%edx
    1213:	89 50 08             	mov    %edx,0x8(%eax)
  ...
  for(j = 0; j < MAX_THREADS; ++j) {
    ...
    1220:	8b 06                	mov    (%esi),%eax
    1222:	85 c0                	test   %eax,%eax
    1224:	0f 95 c2             	setne  %dl
    1227:	83 f8 03             	cmp    $0x3,%eax
    122a:	0f 95 c0             	setne  %al
    122d:	20 d0                	and    %dl,%al
    122f:	74 0a                	je     123b <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
    1231:	8b 7e 04             	mov    0x4(%esi),%edi
    1234:	88 45 e7             	mov    %al,-0x19(%ebp)
    1237:	01 cf                	add    %ecx,%edi
    1239:	89 f9                	mov    %edi,%ecx
    123b:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
    123e:	81 fe 98 20 00 00    	cmp    $0x2098,%esi
    1244:	75 da                	jne    1220 <uthread_yield+0x70>
    1246:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
    124a:	0f 85 ec 00 00 00    	jne    133c <uthread_yield+0x18c>
...
rand()
{
  randstate = randstate * 1664525 + 1013904223;
    1250:	69 05 24 1f 00 00 0d 	imul   $0x19660d,0x1f24,%eax
    1257:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
    1267:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    126c:	a3 24 1f 00 00       	mov    %eax,0x1f24
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
  ...
  printf(1,"current_ticket_num=%d\n", current_ticket_num);
    1275:	e8 16 fc ff ff       	call   e90 <printf>
  printf(1,"randomTicket=%d\n", randomTicket);
    127a:	83 c4 0c             	add    $0xc,%esp
    127d:	56                   	push   %esi
    127e:	68 a4 17 00 00       	push   $0x17a4
    1283:	6a 01                	push   $0x1
    1285:	e8 06 fc ff ff       	call   e90 <printf>

  // set the choosen order thread to run
  choosen = randomTicket / NTICKET;
    128a:	89 f0                	mov    %esi,%eax
    128c:	ba 67 66 66 66       	mov    $0x66666667,%edx
    1291:	c1 fe 1f             	sar    $0x1f,%esi
    1294:	f7 ea                	imul   %edx
    1296:	83 c4 10             	add    $0x10,%esp

  // pick the index of choosen thread
  int chooseCount = -1;
    1299:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  for(j = 0; j < MAX_THREADS; ++j) {
  ...
  choosen = randomTicket / NTICKET;
    12a0:	d1 fa                	sar    %edx
    12a2:	29 f2                	sub    %esi,%edx
    12a4:	89 15 8c 20 00 00    	mov    %edx,0x208c
    12aa:	eb 0f                	jmp    12bb <uthread_yield+0x10b>
  ...
  for(j = 0; j < MAX_THREADS; ++j) {
    ...
    12b3:	83 c3 18             	add    $0x18,%ebx
    12b6:	83 f8 07             	cmp    $0x7,%eax
    12b9:	74 15                	je     12d0 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
    12bb:	83 3b 02             	cmpl   $0x2,(%ebx)
    12be:	75 f0                	jne    12b0 <uthread_yield+0x100>
      chooseCount++;
    12c0:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
    12c3:	39 ca                	cmp    %ecx,%edx
    12c5:	75 e9                	jne    12b0 <uthread_yield+0x100>
  ...
  c_uthread_index = j;
    12d0:	a3 c0 1f 00 00       	mov    %eax,0x1fc0

  // ****************************************************************** //

  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
    12d5:	8d 04 40             	lea    (%eax,%eax,2),%eax
    12d8:	8d 04 c5 e0 1f 00 00 	lea    0x1fe0(,%eax,8),%eax
  ...
  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
    12e2:	c7 40 10 01 00 00 00 	movl   $0x1,0x10(%eax)


  // if esp is null, thread is running its first time, so we have to load a functio to it 
  if(uthread_pool[c_uthread_index].esp == 0) {
    12e9:	85 d2                	test   %edx,%edx
    12eb:	75 23                	jne    1310 <uthread_yield+0x160>
    asm("movl %0, %%esp;" : : "r" (uthread_pool[c_uthread_index].stack + STACK_SIZE - 3*sizeof(int)));
    12ed:	8b 40 0c             	mov    0xc(%eax),%eax
    12f0:	05 f4 0f 00 00       	add    $0xff4,%eax
    12f5:	89 c4                	mov    %eax,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].stack + STACK_SIZE - 3*sizeof(int)));
    12f7:	89 c5                	mov    %eax,%ebp
    // jump to execute function to run the thread own function
    asm("jmp *%0;" : : "r" (execute_thread));
    12f9:	b8 c0 15 00 00       	mov    $0x15c0,%eax
    12fe:	ff e0                	jmp    *%eax
    ...
    1310:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
    1312:	8b 40 08             	mov    0x8(%eax),%eax
    1315:	89 c5                	mov    %eax,%ebp

    // reset alarm
    alarm(UTHREAD_QUANTA);
    1317:	83 ec 0c             	sub    $0xc,%esp
    131a:	6a 05                	push   $0x5
    131c:	e8 b9 fa ff ff       	call   dda <alarm>
    1321:	83 c4 10             	add    $0x10,%esp
  }
}
    1324:	8d 65 f4             	lea    -0xc(%ebp),%esp
    1327:	5b                   	pop    %ebx
    1328:	5e                   	pop    %esi
    1329:	5f                   	pop    %edi
    132a:	5d                   	pop    %ebp
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
    1330:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
    1337:	e9 a0 fe ff ff       	jmp    11dc <uthread_yield+0x2c>
    133c:	89 3d 90 20 00 00    	mov    %edi,0x2090
    1342:	e9 09 ff ff ff       	jmp    1250 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
    1350:	69 05 24 1f 00 00 0d 	imul   $0x19660d,0x1f24,%eax
    1357:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
    135e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    1363:	a3 24 1f 00 00       	mov    %eax,0x1f24
  return randstate;
}
    1368:	c3                   	ret    
    1369:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00001370 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
  ...
  printf(1, "** INIT USER LEVEL THREAD **\n");
    1376:	68 b5 17 00 00       	push   $0x17b5
    137b:	6a 01                	push   $0x1
    137d:	e8 0e fb ff ff       	call   e90 <printf>
    1382:	b8 f0 1f 00 00       	mov    $0x1ff0,%eax
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    ...
    1390:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
    1396:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
    139d:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
    13a0:	3d 98 20 00 00       	cmp    $0x2098,%eax
    13a5:	75 e9                	jne    1390 <uthread_init+0x20>
  ...
  next_tid = 1;
    13aa:	c7 05 88 20 00 00 01 	movl   $0x1,0x2088
    13b1:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
    13b4:	c7 05 c0 1f 00 00 00 	movl   $0x0,0x1fc0
    13bb:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
    13be:	68 b0 11 00 00       	push   $0x11b0
    13c3:	6a 0e                	push   $0xe
  next_tid = 1;
  ...
  uthread_pool[c_uthread_index].tid = 0;
    13c5:	c7 05 e0 1f 00 00 00 	movl   $0x0,0x1fe0
    13cc:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
    13cf:	c7 05 ec 1f 00 00 00 	movl   $0x0,0x1fec
    13d6:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
    13d9:	c7 05 f0 1f 00 00 01 	movl   $0x1,0x1ff0
    13e0:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
    13e3:	e8 da f9 ff ff       	call   dc2 <signal>
    13e8:	83 c4 10             	add    $0x10,%esp
    13eb:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
    13ed:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
    13f2:	75 0f                	jne    1403 <uthread_init+0x93>
    // case signal error
    return -1;
  }
  ...
  alarm(UTHREAD_QUANTA);
    ...
    13f7:	6a 05                	push   $0x5
    13f9:	e8 dc f9 ff ff       	call   dda <alarm>
...
uthread_create(void (*func)(void *), void* arg)
{
  ...
  printf(1, "start thread creation \n");
    ...
    1418:	68 d3 17 00 00       	push   $0x17d3
    141d:	6a 01                	push   $0x1
    141f:	e8 6c fa ff ff       	call   e90 <printf>
  ...
  alarm(0);
    1424:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    142b:	e8 aa f9 ff ff       	call   dda <alarm>

  printf(1, "uthread_create after alarm(0) \n");
    1430:	5b                   	pop    %ebx
    1431:	5e                   	pop    %esi
    1432:	68 00 18 00 00       	push   $0x1800
    1437:	6a 01                	push   $0x1
    1439:	e8 52 fa ff ff       	call   e90 <printf>
    143e:	ba f0 1f 00 00       	mov    $0x1ff0,%edx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    ...
    1454:	74 2a                	je     1480 <uthread_create+0x70>
  alarm(0);
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    ...
    1459:	83 c2 18             	add    $0x18,%edx
    145c:	83 f8 07             	cmp    $0x7,%eax
    145f:	75 ef                	jne    1450 <uthread_create+0x40>
    }
  }
  ...
  alarm(UTHREAD_QUANTA);
    ...
    1464:	6a 05                	push   $0x5
    1466:	e8 6f f9 ff ff       	call   dda <alarm>
  return -1;
  ...
  alarm(UTHREAD_QUANTA);
  return -1;
    1471:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  // enable thread switching
  printf(1, "creation method: returning.. \n");
  alarm(UTHREAD_QUANTA);
...
load_t:
  ...
  uthread_pool[i].tid = next_tid;
    1480:	8b 15 88 20 00 00    	mov    0x2088,%edx
    1486:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
  ...
  uthread_pool[i].stack = malloc(STACK_SIZE);
    ...
    148c:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
    1491:	c1 e3 03             	shl    $0x3,%ebx
    1494:	89 93 e0 1f 00 00    	mov    %edx,0x1fe0(%ebx)
  // update next tid
  next_tid++;
    149a:	83 c2 01             	add    $0x1,%edx
    149d:	89 15 88 20 00 00    	mov    %edx,0x2088
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
    14a3:	e8 18 fc ff ff       	call   10c0 <malloc>
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
    14ab:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
    14b2:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
    14b5:	89 83 ec 1f 00 00    	mov    %eax,0x1fec(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
  ...
  uthread_pool[i].state = RUNNABLE;
    14bb:	c7 83 f0 1f 00 00 02 	movl   $0x2,0x1ff0(%ebx)
    14c2:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
    14c5:	c7 83 e4 1f 00 00 00 	movl   $0x0,0x1fe4(%ebx)
    14cc:	00 00 00 
  uthread_pool[i].ebp = 0;
    14cf:	c7 83 e8 1f 00 00 00 	movl   $0x0,0x1fe8(%ebx)
    14d6:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
    14d9:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
    14df:	8b 55 0c             	mov    0xc(%ebp),%edx
    14e2:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
  ...
  printf(1, "creation method: returning.. \n");
    14e8:	58                   	pop    %eax
    14e9:	5a                   	pop    %edx
    14ea:	68 20 18 00 00       	push   $0x1820
    14ef:	6a 01                	push   $0x1
    14f1:	e8 9a f9 ff ff       	call   e90 <printf>
  alarm(UTHREAD_QUANTA);
    14f6:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    14fd:	e8 d8 f8 ff ff       	call   dda <alarm>

  return uthread_pool[i].tid;
    1502:	8b 83 e0 1f 00 00    	mov    0x1fe0(%ebx),%eax
    1508:	83 c4 10             	add    $0x10,%esp
}
    150b:	8d 65 f8             	lea    -0x8(%ebp),%esp
    150e:	5b                   	pop    %ebx
    150f:	5e                   	pop    %esi
    1510:	5d                   	pop    %ebp
    1511:	c3                   	ret    
...
uthread_exit(void)
{
  ...
  alarm(0);
    1527:	6a 00                	push   $0x0
    1529:	e8 ac f8 ff ff       	call   dda <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
    152e:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    1533:	83 c4 10             	add    $0x10,%esp
    1536:	8d 14 40             	lea    (%eax,%eax,2),%edx
    1539:	8b 14 d5 ec 1f 00 00 	mov    0x1fec(,%edx,8),%edx
    1540:	85 d2                	test   %edx,%edx
    1542:	74 11                	je     1555 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
    1544:	83 ec 0c             	sub    $0xc,%esp
    1547:	52                   	push   %edx
    1548:	e8 e3 fa ff ff       	call   1030 <free>
    154d:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    1552:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
    1555:	8d 04 40             	lea    (%eax,%eax,2),%eax
    1558:	bb f0 1f 00 00       	mov    $0x1ff0,%ebx
    155d:	c7 04 c5 f0 1f 00 00 	movl   $0x0,0x1ff0(,%eax,8)
    1564:	00 00 00 00 
    1568:	89 d8                	mov    %ebx,%eax
    156a:	eb 0e                	jmp    157a <uthread_exit+0x5a>
    156c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    1570:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
    1573:	3d 98 20 00 00       	cmp    $0x2098,%eax
    1578:	74 26                	je     15a0 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
    157a:	83 38 03             	cmpl   $0x3,(%eax)
    157d:	75 f1                	jne    1570 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
    157f:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
    1585:	eb e9                	jmp    1570 <uthread_exit+0x50>
    1587:	89 f6                	mov    %esi,%esi
    1589:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    1590:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
    1593:	e8 18 fc ff ff       	call   11b0 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
    1598:	81 fb 98 20 00 00    	cmp    $0x2098,%ebx
    159e:	74 11                	je     15b1 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
    15a0:	8b 03                	mov    (%ebx),%eax
    15a2:	85 c0                	test   %eax,%eax
    15a4:	75 ea                	jne    1590 <uthread_exit+0x70>
    15a6:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
    15a9:	81 fb 98 20 00 00    	cmp    $0x2098,%ebx
    15af:	75 ef                	jne    15a0 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
    ...
    15c3:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
    15c6:	68 eb 17 00 00       	push   $0x17eb
    15cb:	6a 01                	push   $0x1
    15cd:	e8 be f8 ff ff       	call   e90 <printf>
  alarm(UTHREAD_QUANTA);
    15d2:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
    15d9:	e8 fc f7 ff ff       	call   dda <alarm>
  start_func(arg);
    15de:	58                   	pop    %eax
    15df:	ff 75 0c             	pushl  0xc(%ebp)
    15e2:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
    15e5:	e8 36 ff ff ff       	call   1520 <uthread_exit>
    15ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000015f0 <uthred_self>:
...
uthred_self(void)
{
  ...
  return uthread_pool[c_uthread_index].tid;
    15f0:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
  }
}
...
uthred_self(void)
{
  ...
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
    15f8:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
    15fb:	5d                   	pop    %ebp
...
uthred_join(int tid)
{
  ...
  if(tid >= next_tid || tid < 0) {
    161a:	39 1d 88 20 00 00    	cmp    %ebx,0x2088
    1620:	7e 60                	jle    1682 <uthred_join+0x72>
    1622:	89 d8                	mov    %ebx,%eax
    1624:	c1 e8 1f             	shr    $0x1f,%eax
    1627:	84 c0                	test   %al,%al
    1629:	75 57                	jne    1682 <uthred_join+0x72>
  }
...
loop:
  ...
  alarm(0);
    ...
    162e:	6a 00                	push   $0x0
    1630:	e8 a5 f7 ff ff       	call   dda <alarm>
    1635:	b8 e0 1f 00 00       	mov    $0x1fe0,%eax
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    ...
    1640:	3b 18                	cmp    (%eax),%ebx
    1642:	74 24                	je     1668 <uthred_join+0x58>
    1644:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
    1647:	3d 88 20 00 00       	cmp    $0x2088,%eax
    164c:	75 f2                	jne    1640 <uthred_join+0x30>
  ...
  alarm(UTHREAD_QUANTA);
    ...
    1651:	6a 05                	push   $0x5
    1653:	e8 82 f7 ff ff       	call   dda <alarm>

  return 0;
    1658:	83 c4 10             	add    $0x10,%esp
    165b:	31 c0                	xor    %eax,%eax
}
    165d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    1660:	c9                   	leave  
    1661:	c3                   	ret    
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    ...
    1668:	a1 c0 1f 00 00       	mov    0x1fc0,%eax
    166d:	8d 04 40             	lea    (%eax,%eax,2),%eax
    1670:	c7 04 c5 f0 1f 00 00 	movl   $0x3,0x1ff0(,%eax,8)
    1677:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
    167b:	e8 30 fb ff ff       	call   11b0 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
    1680:	eb a9                	jmp    162b <uthred_join+0x1b>
{
  int i;
  ...
  if(tid >= next_tid || tid < 0) {
    ...
    1687:	eb d4                	jmp    165d <uthred_join+0x4d>
