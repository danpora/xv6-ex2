...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3af:	f7 f6                	div    %esi
 3b1:	0f b6 92 3c 0c 00 00 	movzbl 0xc3c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 528:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 52b:	b8 33 0c 00 00       	mov    $0xc33,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 e0 10 00 00       	mov    0x10e0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 e0 10 00 00       	mov    %eax,0x10e0
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 e0 10 00 00       	mov    %eax,0x10e0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 e0 10 00 00    	mov    0x10e0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 69f:	76 3f                	jbe    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 6a1:	39 05 e0 10 00 00    	cmp    %eax,0x10e0
 ...
 6c6:	e8 e5 fe ff ff       	call   5b0 <free>
  return freep;
 6cb:	8b 15 e0 10 00 00    	mov    0x10e0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 e0 10 00 00    	mov    %edx,0x10e0
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 e0 10 00 00 e4 	movl   $0x10e4,0x10e0
 70d:	10 00 00 
 710:	c7 05 e4 10 00 00 e4 	movl   $0x10e4,0x10e4
 717:	10 00 00 
    base.s.size = 0;
 71a:	b8 e4 10 00 00       	mov    $0x10e4,%eax
 71f:	c7 05 e8 10 00 00 00 	movl   $0x0,0x10e8
 726:	00 00 00 
...
uthread_yield(void)
{
 ...
 740:	a1 00 11 00 00       	mov    0x1100,%eax
 745:	83 c4 10             	add    $0x10,%esp
 748:	8d 14 40             	lea    (%eax,%eax,2),%edx
 74b:	8d 14 d5 20 11 00 00 	lea    0x1120(,%edx,8),%edx
 ...
 75c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 75f:	83 05 00 11 00 00 01 	addl   $0x1,0x1100
 766:	bb 30 11 00 00       	mov    $0x1130,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 76d:	8d 04 c5 20 11 00 00 	lea    0x1120(,%eax,8),%eax
 ...
 774:	c7 05 d0 11 00 00 ff 	movl   $0xffffffff,0x11d0
 77b:	ff ff ff 
 ...
 7bb:	83 c6 18             	add    $0x18,%esi
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 7be:	81 fe d8 11 00 00    	cmp    $0x11d8,%esi
...
rand()
{
 ...
 7d0:	69 05 c0 10 00 00 0d 	imul   $0x19660d,0x10c0,%eax
 7d7:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
rand()
{
 ...
 7ec:	a3 c0 10 00 00       	mov    %eax,0x10c0
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
 ...
 824:	89 15 cc 11 00 00    	mov    %edx,0x11cc
 ...
 858:	8d 04 c5 20 11 00 00 	lea    0x1120(,%eax,8),%eax
 ...
 8bc:	89 3d d0 11 00 00    	mov    %edi,0x11d0
...
{
  randstate = randstate * 1664525 + 1013904223;
 8d0:	69 05 c0 10 00 00 0d 	imul   $0x19660d,0x10c0,%eax
 8d7:	66 19 00 
//***************************************************************************************//
...
rand()
{
 ...
 8e3:	a3 c0 10 00 00       	mov    %eax,0x10c0
  return randstate;
}
 8e8:	c3                   	ret    
 ...
 uthread_init()
{
 ...
 8f6:	68 75 0c 00 00       	push   $0xc75
 8fb:	6a 01                	push   $0x1
 8fd:	e8 0e fb ff ff       	call   410 <printf>
 902:	b8 30 11 00 00       	mov    $0x1130,%eax
 ...
 uthread_init()
{
  ...
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 920:	3d d8 11 00 00       	cmp    $0x11d8,%eax
 ...
 927:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 92a:	c7 05 c8 11 00 00 01 	movl   $0x1,0x11c8
 931:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 934:	c7 05 00 11 00 00 00 	movl   $0x0,0x1100
 93b:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 945:	c7 05 20 11 00 00 00 	movl   $0x0,0x1120
 94c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 94f:	c7 05 2c 11 00 00 00 	movl   $0x0,0x112c
 956:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 959:	c7 05 30 11 00 00 01 	movl   $0x1,0x1130
 960:	00 00 00 
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 9b0:	5b                   	pop    %ebx
 9b1:	5e                   	pop    %esi
 9b2:	68 c0 0c 00 00       	push   $0xcc0
 9b7:	6a 01                	push   $0x1
 9b9:	e8 52 fa ff ff       	call   410 <printf>
 9be:	ba 30 11 00 00       	mov    $0x1130,%edx
...
load_t:
 ...
 a00:	8b 15 c8 11 00 00    	mov    0x11c8,%edx
...
load_t:
 ...
 a14:	89 93 20 11 00 00    	mov    %edx,0x1120(%ebx)
  // update next tid
  next_tid++;
 a1a:	83 c2 01             	add    $0x1,%edx
 a1d:	89 15 c8 11 00 00    	mov    %edx,0x11c8
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ...
 a32:	00 00 00 
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 a35:	89 83 2c 11 00 00    	mov    %eax,0x112c(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 a3b:	c7 83 30 11 00 00 02 	movl   $0x2,0x1130(%ebx)
 a42:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 a45:	c7 83 24 11 00 00 00 	movl   $0x0,0x1124(%ebx)
 a4c:	00 00 00 
  uthread_pool[i].ebp = 0;
 a4f:	c7 83 28 11 00 00 00 	movl   $0x0,0x1128(%ebx)
 a56:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ...
 a7d:	e8 d8 f8 ff ff       	call   35a <alarm>
  ...
  return uthread_pool[i].tid;
 a82:	8b 83 20 11 00 00    	mov    0x1120(%ebx),%eax
...
uthread_exit(void)
{
 ...
 aae:	a1 00 11 00 00       	mov    0x1100,%eax
 ab3:	83 c4 10             	add    $0x10,%esp
 ab6:	8d 14 40             	lea    (%eax,%eax,2),%edx
 ab9:	8b 14 d5 2c 11 00 00 	mov    0x112c(,%edx,8),%edx
 ...
 acd:	a1 00 11 00 00       	mov    0x1100,%eax
 ...
 ad8:	bb 30 11 00 00       	mov    $0x1130,%ebx
 add:	c7 04 c5 30 11 00 00 	movl   $0x0,0x1130(,%eax,8)
 ae4:	00 00 00 00 
 ...
 af0:	83 c0 18             	add    $0x18,%eax
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
 af3:	3d d8 11 00 00       	cmp    $0x11d8,%eax
 ...
 b13:	e8 18 fc ff ff       	call   730 <uthread_yield>
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 b18:	81 fb d8 11 00 00    	cmp    $0x11d8,%ebx
 ...
 b26:	83 c3 18             	add    $0x18,%ebx
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 b29:	81 fb d8 11 00 00    	cmp    $0x11d8,%ebx
...
uthred_self(void)
{
 ...
 b70:	a1 00 11 00 00       	mov    0x1100,%eax
  }
}
...
uthred_self(void)
{
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 b7c:	8b 04 c5 20 11 00 00 	mov    0x1120(,%eax,8),%eax
}
 b83:	c3                   	ret    
...
uthred_join(int tid)
{
 ...
 b9a:	39 1d c8 11 00 00    	cmp    %ebx,0x11c8
...
loop:
 ...
 bb5:	b8 20 11 00 00       	mov    $0x1120,%eax
 ...
 bc4:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 bc7:	3d c8 11 00 00       	cmp    $0x11c8,%eax
 ...
 be8:	a1 00 11 00 00       	mov    0x1100,%eax
 bed:	8d 04 40             	lea    (%eax,%eax,2),%eax
 bf0:	c7 04 c5 30 11 00 00 	movl   $0x3,0x1130(,%eax,8)
 bf7:	03 00 00 00 
