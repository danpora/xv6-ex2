...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37f:	f7 f6                	div    %esi
 381:	0f b6 92 e4 0b 00 00 	movzbl 0xbe4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4f8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4fb:	b8 dc 0b 00 00       	mov    $0xbdc,%eax
...
free(void *ap)
{
 ...
 581:	a1 80 10 00 00       	mov    0x1080,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5d7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5d9:	a3 80 10 00 00       	mov    %eax,0x1080
}
 5de:	5b                   	pop    %ebx
 5df:	5e                   	pop    %esi
 5e0:	5f                   	pop    %edi
 ...
 5fa:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5fd:	a3 80 10 00 00       	mov    %eax,0x1080
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 80 10 00 00    	mov    0x1080,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 66f:	76 3f                	jbe    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 671:	39 05 80 10 00 00    	cmp    %eax,0x1080
 ...
 696:	e8 e5 fe ff ff       	call   580 <free>
  return freep;
 69b:	8b 15 80 10 00 00    	mov    0x1080,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6bc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6bf:	89 15 80 10 00 00    	mov    %edx,0x1080
      return (void*)(p + 1);
 ...
 6d4:	eb e9                	jmp    6bf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6d6:	c7 05 80 10 00 00 84 	movl   $0x1084,0x1080
 6dd:	10 00 00 
 6e0:	c7 05 84 10 00 00 84 	movl   $0x1084,0x1084
 6e7:	10 00 00 
    base.s.size = 0;
 6ea:	b8 84 10 00 00       	mov    $0x1084,%eax
 6ef:	c7 05 88 10 00 00 00 	movl   $0x0,0x1088
 6f6:	00 00 00 
 6f9:	e9 3e ff ff ff       	jmp    63c <malloc+0x2c>
 6fe:	66 90                	xchg   %ax,%ax

00000700 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
 ...
 706:	83 ec 28             	sub    $0x28,%esp
  ...
  alarm(0);
 709:	6a 00                	push   $0x0
 70b:	e8 1a fc ff ff       	call   32a <alarm>
 ...
 710:	a1 a0 10 00 00       	mov    0x10a0,%eax
 715:	83 c4 10             	add    $0x10,%esp
 718:	8d 14 40             	lea    (%eax,%eax,2),%edx
 71b:	8d 14 d5 c0 10 00 00 	lea    0x10c0(,%edx,8),%edx
 722:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
 726:	0f 84 54 01 00 00    	je     880 <uthread_yield+0x180>
 ...
 72c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 72f:	83 05 a0 10 00 00 01 	addl   $0x1,0x10a0
 736:	bb d0 10 00 00       	mov    $0x10d0,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
 73b:	89 e2                	mov    %esp,%edx
 73d:	8d 04 c5 c0 10 00 00 	lea    0x10c0(,%eax,8),%eax
 ...
 744:	c7 05 70 11 00 00 ff 	movl   $0xffffffff,0x1170
 74b:	ff ff ff 
 74e:	89 de                	mov    %ebx,%esi
 750:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
 754:	bf ff ff ff ff       	mov    $0xffffffff,%edi
 759:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 770:	8b 06                	mov    (%esi),%eax
 772:	85 c0                	test   %eax,%eax
 774:	0f 95 c2             	setne  %dl
 777:	83 f8 03             	cmp    $0x3,%eax
 77a:	0f 95 c0             	setne  %al
 77d:	20 d0                	and    %dl,%al
 77f:	74 0a                	je     78b <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
 781:	8b 7e 04             	mov    0x4(%esi),%edi
 784:	88 45 e7             	mov    %al,-0x19(%ebp)
 787:	01 cf                	add    %ecx,%edi
 789:	89 f9                	mov    %edi,%ecx
 78b:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 78e:	81 fe 78 11 00 00    	cmp    $0x1178,%esi
 794:	75 da                	jne    770 <uthread_yield+0x70>
 796:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
 79a:	0f 85 ec 00 00 00    	jne    88c <uthread_yield+0x18c>
...
rand()
{
 ...
 7a0:	69 05 64 10 00 00 0d 	imul   $0x19660d,0x1064,%eax
 7a7:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
 7b7:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 7bc:	a3 64 10 00 00       	mov    %eax,0x1064
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
  ...
  randomTicket = rand() % current_ticket_num;
 7c1:	f7 f1                	div    %ecx
 7c3:	89 d6                	mov    %edx,%esi

  printf(1,"current_ticket_num=%d\n", current_ticket_num);
 7c5:	e8 16 fc ff ff       	call   3e0 <printf>
  printf(1,"randomTicket=%d\n", randomTicket);
 7ca:	83 c4 0c             	add    $0xc,%esp
 7cd:	56                   	push   %esi
 7ce:	68 0c 0c 00 00       	push   $0xc0c
 7d3:	6a 01                	push   $0x1
 7d5:	e8 06 fc ff ff       	call   3e0 <printf>

  // set the choosen order thread to run
  choosen = randomTicket / NTICKET;
 7da:	89 f0                	mov    %esi,%eax
 7dc:	ba 67 66 66 66       	mov    $0x66666667,%edx
 7e1:	c1 fe 1f             	sar    $0x1f,%esi
 7e4:	f7 ea                	imul   %edx
 7e6:	83 c4 10             	add    $0x10,%esp

  // pick the index of choosen thread
  int chooseCount = -1;
 7e9:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  for(j = 0; j < MAX_THREADS; ++j) {
 7ee:	31 c0                	xor    %eax,%eax
  ...
  choosen = randomTicket / NTICKET;
 7f0:	d1 fa                	sar    %edx
 7f2:	29 f2                	sub    %esi,%edx
 7f4:	89 15 6c 11 00 00    	mov    %edx,0x116c
 7fa:	eb 0f                	jmp    80b <uthread_yield+0x10b>
 ...
 803:	83 c3 18             	add    $0x18,%ebx
 806:	83 f8 07             	cmp    $0x7,%eax
 809:	74 15                	je     820 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
 80b:	83 3b 02             	cmpl   $0x2,(%ebx)
 80e:	75 f0                	jne    800 <uthread_yield+0x100>
      chooseCount++;
 810:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
 813:	39 ca                	cmp    %ecx,%edx
 815:	75 e9                	jne    800 <uthread_yield+0x100>
 ...
 819:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 820:	a3 a0 10 00 00       	mov    %eax,0x10a0

  // ****************************************************************** //

  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
 825:	8d 04 40             	lea    (%eax,%eax,2),%eax
 828:	8d 04 c5 c0 10 00 00 	lea    0x10c0(,%eax,8),%eax
 ...
 860:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
 862:	8b 40 08             	mov    0x8(%eax),%eax
 865:	89 c5                	mov    %eax,%ebp

    // reset alarm
    alarm(UTHREAD_QUANTA);
 867:	83 ec 0c             	sub    $0xc,%esp
 86a:	6a 05                	push   $0x5
 86c:	e8 b9 fa ff ff       	call   32a <alarm>
 ...
 87c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
 880:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
 887:	e9 a0 fe ff ff       	jmp    72c <uthread_yield+0x2c>
 88c:	89 3d 70 11 00 00    	mov    %edi,0x1170
 892:	e9 09 ff ff ff       	jmp    7a0 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
 8a0:	69 05 64 10 00 00 0d 	imul   $0x19660d,0x1064,%eax
 8a7:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
 8ae:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 8b3:	a3 64 10 00 00       	mov    %eax,0x1064
  return randstate;
}
 8b8:	c3                   	ret    
 8b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000008c0 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
 ...
 8c6:	68 1d 0c 00 00       	push   $0xc1d
 8cb:	6a 01                	push   $0x1
 8cd:	e8 0e fb ff ff       	call   3e0 <printf>
 8d2:	b8 d0 10 00 00       	mov    $0x10d0,%eax
 ...
 8e0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
 8e6:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
 8ed:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 8f0:	3d 78 11 00 00       	cmp    $0x1178,%eax
 8f5:	75 e9                	jne    8e0 <uthread_init+0x20>
 ...
 8f7:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 8fa:	c7 05 68 11 00 00 01 	movl   $0x1,0x1168
 901:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 904:	c7 05 a0 10 00 00 00 	movl   $0x0,0x10a0
 90b:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 915:	c7 05 c0 10 00 00 00 	movl   $0x0,0x10c0
 91c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 91f:	c7 05 cc 10 00 00 00 	movl   $0x0,0x10cc
 926:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 929:	c7 05 d0 10 00 00 01 	movl   $0x1,0x10d0
 930:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 933:	e8 da f9 ff ff       	call   312 <signal>
 938:	83 c4 10             	add    $0x10,%esp
 93b:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
 93d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 942:	75 0f                	jne    953 <uthread_init+0x93>
    // case signal error
    return -1;
  }
 ...
 947:	6a 05                	push   $0x5
 949:	e8 dc f9 ff ff       	call   32a <alarm>
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 968:	68 3b 0c 00 00       	push   $0xc3b
 96d:	6a 01                	push   $0x1
 96f:	e8 6c fa ff ff       	call   3e0 <printf>
  ...
  alarm(0);
 974:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 97b:	e8 aa f9 ff ff       	call   32a <alarm>

  printf(1, "uthread_create after alarm(0) \n");
 980:	5b                   	pop    %ebx
 981:	5e                   	pop    %esi
 982:	68 68 0c 00 00       	push   $0xc68
 987:	6a 01                	push   $0x1
 989:	e8 52 fa ff ff       	call   3e0 <printf>
 98e:	ba d0 10 00 00       	mov    $0x10d0,%edx
 ...
 9a4:	74 2a                	je     9d0 <uthread_create+0x70>
  alarm(0);
 ...
 9a9:	83 c2 18             	add    $0x18,%edx
 9ac:	83 f8 07             	cmp    $0x7,%eax
 9af:	75 ef                	jne    9a0 <uthread_create+0x40>
    }
  }
 ...
 9b4:	6a 05                	push   $0x5
 9b6:	e8 6f f9 ff ff       	call   32a <alarm>
  return -1;
...
load_t:
 ...
 9d0:	8b 15 68 11 00 00    	mov    0x1168,%edx
 9d6:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
 ...
 9dc:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
 9e1:	c1 e3 03             	shl    $0x3,%ebx
 9e4:	89 93 c0 10 00 00    	mov    %edx,0x10c0(%ebx)
  // update next tid
  next_tid++;
 9ea:	83 c2 01             	add    $0x1,%edx
 9ed:	89 15 68 11 00 00    	mov    %edx,0x1168
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 9f3:	e8 18 fc ff ff       	call   610 <malloc>
 ...
 9f8:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
 9fb:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 a02:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 a05:	89 83 cc 10 00 00    	mov    %eax,0x10cc(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 a0b:	c7 83 d0 10 00 00 02 	movl   $0x2,0x10d0(%ebx)
 a12:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 a15:	c7 83 c4 10 00 00 00 	movl   $0x0,0x10c4(%ebx)
 a1c:	00 00 00 
  uthread_pool[i].ebp = 0;
 a1f:	c7 83 c8 10 00 00 00 	movl   $0x0,0x10c8(%ebx)
 a26:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 a29:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
 a2f:	8b 55 0c             	mov    0xc(%ebp),%edx
 a32:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
 ...
 a38:	58                   	pop    %eax
 a39:	5a                   	pop    %edx
 a3a:	68 88 0c 00 00       	push   $0xc88
 a3f:	6a 01                	push   $0x1
 a41:	e8 9a f9 ff ff       	call   3e0 <printf>
  alarm(UTHREAD_QUANTA);
 a46:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 a4d:	e8 d8 f8 ff ff       	call   32a <alarm>

  return uthread_pool[i].tid;
 a52:	8b 83 c0 10 00 00    	mov    0x10c0(%ebx),%eax
 a58:	83 c4 10             	add    $0x10,%esp
}
 a5b:	8d 65 f8             	lea    -0x8(%ebp),%esp
 a5e:	5b                   	pop    %ebx
 a5f:	5e                   	pop    %esi
 a60:	5d                   	pop    %ebp
 a61:	c3                   	ret    
...
uthread_exit(void)
{
 ...
 a74:	83 ec 10             	sub    $0x10,%esp
  ...
  alarm(0);
 a77:	6a 00                	push   $0x0
 a79:	e8 ac f8 ff ff       	call   32a <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
 a7e:	a1 a0 10 00 00       	mov    0x10a0,%eax
 a83:	83 c4 10             	add    $0x10,%esp
 a86:	8d 14 40             	lea    (%eax,%eax,2),%edx
 a89:	8b 14 d5 cc 10 00 00 	mov    0x10cc(,%edx,8),%edx
 a90:	85 d2                	test   %edx,%edx
 a92:	74 11                	je     aa5 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
 a94:	83 ec 0c             	sub    $0xc,%esp
 a97:	52                   	push   %edx
 a98:	e8 e3 fa ff ff       	call   580 <free>
 a9d:	a1 a0 10 00 00       	mov    0x10a0,%eax
 aa2:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
 aa5:	8d 04 40             	lea    (%eax,%eax,2),%eax
 aa8:	bb d0 10 00 00       	mov    $0x10d0,%ebx
 aad:	c7 04 c5 d0 10 00 00 	movl   $0x0,0x10d0(,%eax,8)
 ab4:	00 00 00 00 
 ab8:	89 d8                	mov    %ebx,%eax
 aba:	eb 0e                	jmp    aca <uthread_exit+0x5a>
 abc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 ac0:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
 ac3:	3d 78 11 00 00       	cmp    $0x1178,%eax
 ac8:	74 26                	je     af0 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
 aca:	83 38 03             	cmpl   $0x3,(%eax)
 acd:	75 f1                	jne    ac0 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
 acf:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
 ad5:	eb e9                	jmp    ac0 <uthread_exit+0x50>
 ad7:	89 f6                	mov    %esi,%esi
 ad9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 ae0:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
 ae3:	e8 18 fc ff ff       	call   700 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 ae8:	81 fb 78 11 00 00    	cmp    $0x1178,%ebx
 aee:	74 11                	je     b01 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
 af0:	8b 03                	mov    (%ebx),%eax
 af2:	85 c0                	test   %eax,%eax
 af4:	75 ea                	jne    ae0 <uthread_exit+0x70>
 af6:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 af9:	81 fb 78 11 00 00    	cmp    $0x1178,%ebx
 aff:	75 ef                	jne    af0 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
 ...
 b13:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
 b16:	68 53 0c 00 00       	push   $0xc53
 b1b:	6a 01                	push   $0x1
 b1d:	e8 be f8 ff ff       	call   3e0 <printf>
  alarm(UTHREAD_QUANTA);
 b22:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 b29:	e8 fc f7 ff ff       	call   32a <alarm>
  start_func(arg);
 b2e:	58                   	pop    %eax
 b2f:	ff 75 0c             	pushl  0xc(%ebp)
 b32:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
 b35:	e8 36 ff ff ff       	call   a70 <uthread_exit>
 b3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000b40 <uthred_self>:
...
uthred_self(void)
{
 ...
 b40:	a1 a0 10 00 00       	mov    0x10a0,%eax
  }
}
...
uthred_self(void)
{
 ...
 b46:	89 e5                	mov    %esp,%ebp
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 b48:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
 b4b:	5d                   	pop    %ebp
...
uthred_join(int tid)
{
 ...
 b6a:	39 1d 68 11 00 00    	cmp    %ebx,0x1168
 b70:	7e 60                	jle    bd2 <uthred_join+0x72>
 b72:	89 d8                	mov    %ebx,%eax
 b74:	c1 e8 1f             	shr    $0x1f,%eax
 b77:	84 c0                	test   %al,%al
 b79:	75 57                	jne    bd2 <uthred_join+0x72>
  }
...
loop:
 ...
 b7e:	6a 00                	push   $0x0
 b80:	e8 a5 f7 ff ff       	call   32a <alarm>
 b85:	b8 c0 10 00 00       	mov    $0x10c0,%eax
 ...
 b90:	3b 18                	cmp    (%eax),%ebx
 b92:	74 24                	je     bb8 <uthred_join+0x58>
 b94:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 b97:	3d 68 11 00 00       	cmp    $0x1168,%eax
 b9c:	75 f2                	jne    b90 <uthred_join+0x30>
 ...
 ba1:	6a 05                	push   $0x5
 ba3:	e8 82 f7 ff ff       	call   32a <alarm>

  return 0;
 ba8:	83 c4 10             	add    $0x10,%esp
 bab:	31 c0                	xor    %eax,%eax
}
 bad:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 bb0:	c9                   	leave  
 bb1:	c3                   	ret    
 ...
 bb8:	a1 a0 10 00 00       	mov    0x10a0,%eax
 bbd:	8d 04 40             	lea    (%eax,%eax,2),%eax
 bc0:	c7 04 c5 d0 10 00 00 	movl   $0x3,0x10d0(,%eax,8)
 bc7:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
 bcb:	e8 30 fb ff ff       	call   700 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
 bd0:	eb a9                	jmp    b7b <uthred_join+0x1b>
{
  int i;
 ...
 bd7:	eb d4                	jmp    bad <uthred_join+0x4d>
