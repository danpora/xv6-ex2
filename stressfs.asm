...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 18 0d 00 00 	movzbl 0xd18(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 608:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 60b:	b8 0f 0d 00 00       	mov    $0xd0f,%eax
...
free(void *ap)
{
 ...
 691:	a1 c0 11 00 00       	mov    0x11c0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6e9:	a3 c0 11 00 00       	mov    %eax,0x11c0
}
 6ee:	5b                   	pop    %ebx
 6ef:	5e                   	pop    %esi
 6f0:	5f                   	pop    %edi
 ...
 70a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 70d:	a3 c0 11 00 00       	mov    %eax,0x11c0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 15 c0 11 00 00    	mov    0x11c0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 77f:	76 3f                	jbe    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	39 05 c0 11 00 00    	cmp    %eax,0x11c0
 ...
 7a6:	e8 e5 fe ff ff       	call   690 <free>
  return freep;
 7ab:	8b 15 c0 11 00 00    	mov    0x11c0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 c0 11 00 00 c4 	movl   $0x11c4,0x11c0
 7ed:	11 00 00 
 7f0:	c7 05 c4 11 00 00 c4 	movl   $0x11c4,0x11c4
 7f7:	11 00 00 
    base.s.size = 0;
 7fa:	b8 c4 11 00 00       	mov    $0x11c4,%eax
 7ff:	c7 05 c8 11 00 00 00 	movl   $0x0,0x11c8
 806:	00 00 00 
 809:	e9 3e ff ff ff       	jmp    74c <malloc+0x2c>
 80e:	66 90                	xchg   %ax,%ax

00000810 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
 ...
 816:	83 ec 28             	sub    $0x28,%esp
  ...
  alarm(0);
 819:	6a 00                	push   $0x0
 81b:	e8 1a fc ff ff       	call   43a <alarm>
 ...
 820:	a1 e0 11 00 00       	mov    0x11e0,%eax
 825:	83 c4 10             	add    $0x10,%esp
 828:	8d 14 40             	lea    (%eax,%eax,2),%edx
 82b:	8d 14 d5 00 12 00 00 	lea    0x1200(,%edx,8),%edx
 832:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
 836:	0f 84 54 01 00 00    	je     990 <uthread_yield+0x180>
 ...
 83c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 83f:	83 05 e0 11 00 00 01 	addl   $0x1,0x11e0
 846:	bb 10 12 00 00       	mov    $0x1210,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
 84b:	89 e2                	mov    %esp,%edx
 84d:	8d 04 c5 00 12 00 00 	lea    0x1200(,%eax,8),%eax
 ...
 854:	c7 05 b0 12 00 00 ff 	movl   $0xffffffff,0x12b0
 85b:	ff ff ff 
 85e:	89 de                	mov    %ebx,%esi
 860:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
 864:	bf ff ff ff ff       	mov    $0xffffffff,%edi
 ...
 86e:	89 50 04             	mov    %edx,0x4(%eax)
  asm("movl %%ebp, %0;" : "=r" (uthread_pool[c_uthread_index].ebp));
 871:	89 ea                	mov    %ebp,%edx
 873:	89 50 08             	mov    %edx,0x8(%eax)
 ...
 880:	8b 06                	mov    (%esi),%eax
 882:	85 c0                	test   %eax,%eax
 884:	0f 95 c2             	setne  %dl
 887:	83 f8 03             	cmp    $0x3,%eax
 88a:	0f 95 c0             	setne  %al
 88d:	20 d0                	and    %dl,%al
 88f:	74 0a                	je     89b <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
 891:	8b 7e 04             	mov    0x4(%esi),%edi
 894:	88 45 e7             	mov    %al,-0x19(%ebp)
 897:	01 cf                	add    %ecx,%edi
 899:	89 f9                	mov    %edi,%ecx
 89b:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 89e:	81 fe b8 12 00 00    	cmp    $0x12b8,%esi
 8a4:	75 da                	jne    880 <uthread_yield+0x70>
 8a6:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
 8aa:	0f 85 ec 00 00 00    	jne    99c <uthread_yield+0x18c>
...
rand()
{
 ...
 8b0:	69 05 a4 11 00 00 0d 	imul   $0x19660d,0x11a4,%eax
 8b7:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
 8c7:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 8cc:	a3 a4 11 00 00       	mov    %eax,0x11a4
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
 ...
 8fe:	31 c0                	xor    %eax,%eax
  ...
  choosen = randomTicket / NTICKET;
 900:	d1 fa                	sar    %edx
 902:	29 f2                	sub    %esi,%edx
 904:	89 15 ac 12 00 00    	mov    %edx,0x12ac
 90a:	eb 0f                	jmp    91b <uthread_yield+0x10b>
 ...
 913:	83 c3 18             	add    $0x18,%ebx
 916:	83 f8 07             	cmp    $0x7,%eax
 919:	74 15                	je     930 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
 91b:	83 3b 02             	cmpl   $0x2,(%ebx)
 91e:	75 f0                	jne    910 <uthread_yield+0x100>
      chooseCount++;
 920:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
 923:	39 ca                	cmp    %ecx,%edx
 925:	75 e9                	jne    910 <uthread_yield+0x100>
 ...
 929:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 930:	a3 e0 11 00 00       	mov    %eax,0x11e0

  // ****************************************************************** //

  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
 935:	8d 04 40             	lea    (%eax,%eax,2),%eax
 938:	8d 04 c5 00 12 00 00 	lea    0x1200(,%eax,8),%eax
 ...
 970:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
 972:	8b 40 08             	mov    0x8(%eax),%eax
 975:	89 c5                	mov    %eax,%ebp

    // reset alarm
    alarm(UTHREAD_QUANTA);
 977:	83 ec 0c             	sub    $0xc,%esp
 97a:	6a 05                	push   $0x5
 97c:	e8 b9 fa ff ff       	call   43a <alarm>
 ...
 98c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
 990:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
 997:	e9 a0 fe ff ff       	jmp    83c <uthread_yield+0x2c>
 99c:	89 3d b0 12 00 00    	mov    %edi,0x12b0
 9a2:	e9 09 ff ff ff       	jmp    8b0 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
 9b0:	69 05 a4 11 00 00 0d 	imul   $0x19660d,0x11a4,%eax
 9b7:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
 9be:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 9c3:	a3 a4 11 00 00       	mov    %eax,0x11a4
  return randstate;
}
 9c8:	c3                   	ret    
 9c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

000009d0 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
 ...
 9d6:	68 51 0d 00 00       	push   $0xd51
 9db:	6a 01                	push   $0x1
 9dd:	e8 0e fb ff ff       	call   4f0 <printf>
 9e2:	b8 10 12 00 00       	mov    $0x1210,%eax
 ...
 9f0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
 9f6:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
 9fd:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 a00:	3d b8 12 00 00       	cmp    $0x12b8,%eax
 a05:	75 e9                	jne    9f0 <uthread_init+0x20>
 ...
 a07:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 a0a:	c7 05 a8 12 00 00 01 	movl   $0x1,0x12a8
 a11:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 a14:	c7 05 e0 11 00 00 00 	movl   $0x0,0x11e0
 a1b:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 a25:	c7 05 00 12 00 00 00 	movl   $0x0,0x1200
 a2c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 a2f:	c7 05 0c 12 00 00 00 	movl   $0x0,0x120c
 a36:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 a39:	c7 05 10 12 00 00 01 	movl   $0x1,0x1210
 a40:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 a43:	e8 da f9 ff ff       	call   422 <signal>
 a48:	83 c4 10             	add    $0x10,%esp
 a4b:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
 a4d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 a52:	75 0f                	jne    a63 <uthread_init+0x93>
    // case signal error
    return -1;
  }
 ...
 a57:	6a 05                	push   $0x5
 a59:	e8 dc f9 ff ff       	call   43a <alarm>
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 a78:	68 6f 0d 00 00       	push   $0xd6f
 a7d:	6a 01                	push   $0x1
 a7f:	e8 6c fa ff ff       	call   4f0 <printf>
  ...
  alarm(0);
 a84:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 a8b:	e8 aa f9 ff ff       	call   43a <alarm>

  printf(1, "uthread_create after alarm(0) \n");
 a90:	5b                   	pop    %ebx
 a91:	5e                   	pop    %esi
 a92:	68 9c 0d 00 00       	push   $0xd9c
 a97:	6a 01                	push   $0x1
 a99:	e8 52 fa ff ff       	call   4f0 <printf>
 a9e:	ba 10 12 00 00       	mov    $0x1210,%edx
 ...
 ab2:	85 c9                	test   %ecx,%ecx
 ab4:	74 2a                	je     ae0 <uthread_create+0x70>
  alarm(0);
  ...
  // search for free thread to load
  for(i = 0; i < MAX_THREADS; ++i) {
 ab6:	83 c0 01             	add    $0x1,%eax
 ab9:	83 c2 18             	add    $0x18,%edx
 abc:	83 f8 07             	cmp    $0x7,%eax
 abf:	75 ef                	jne    ab0 <uthread_create+0x40>
    }
  }
 ...
 ac4:	6a 05                	push   $0x5
 ac6:	e8 6f f9 ff ff       	call   43a <alarm>
  return -1;
 ...
 ace:	8d 65 f8             	lea    -0x8(%ebp),%esp
  ...
  alarm(UTHREAD_QUANTA);
  return -1;
 ad1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  // enable thread switching
  printf(1, "creation method: returning.. \n");
  alarm(UTHREAD_QUANTA);
...
load_t:
 ...
 ae0:	8b 15 a8 12 00 00    	mov    0x12a8,%edx
 ae6:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
 ...
 aec:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
 af1:	c1 e3 03             	shl    $0x3,%ebx
 af4:	89 93 00 12 00 00    	mov    %edx,0x1200(%ebx)
  // update next tid
  next_tid++;
 afa:	83 c2 01             	add    $0x1,%edx
 afd:	89 15 a8 12 00 00    	mov    %edx,0x12a8
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 b03:	e8 18 fc ff ff       	call   720 <malloc>
 ...
 b08:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
 b0b:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 b12:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 b15:	89 83 0c 12 00 00    	mov    %eax,0x120c(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 b1b:	c7 83 10 12 00 00 02 	movl   $0x2,0x1210(%ebx)
 b22:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 b25:	c7 83 04 12 00 00 00 	movl   $0x0,0x1204(%ebx)
 b2c:	00 00 00 
  uthread_pool[i].ebp = 0;
 b2f:	c7 83 08 12 00 00 00 	movl   $0x0,0x1208(%ebx)
 b36:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 b39:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
 b3f:	8b 55 0c             	mov    0xc(%ebp),%edx
 b42:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
 ...
 b48:	58                   	pop    %eax
 b49:	5a                   	pop    %edx
 b4a:	68 bc 0d 00 00       	push   $0xdbc
 b4f:	6a 01                	push   $0x1
 b51:	e8 9a f9 ff ff       	call   4f0 <printf>
  alarm(UTHREAD_QUANTA);
 b56:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 b5d:	e8 d8 f8 ff ff       	call   43a <alarm>

  return uthread_pool[i].tid;
 b62:	8b 83 00 12 00 00    	mov    0x1200(%ebx),%eax
 b68:	83 c4 10             	add    $0x10,%esp
}
 b6b:	8d 65 f8             	lea    -0x8(%ebp),%esp
 b6e:	5b                   	pop    %ebx
 b6f:	5e                   	pop    %esi
 b70:	5d                   	pop    %ebp
 b71:	c3                   	ret    
 b72:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 b79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000b80 <uthread_exit>:
...
uthread_exit(void)
{
 ...
 b84:	83 ec 10             	sub    $0x10,%esp
  ...
  alarm(0);
 b87:	6a 00                	push   $0x0
 b89:	e8 ac f8 ff ff       	call   43a <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
 b8e:	a1 e0 11 00 00       	mov    0x11e0,%eax
 b93:	83 c4 10             	add    $0x10,%esp
 b96:	8d 14 40             	lea    (%eax,%eax,2),%edx
 b99:	8b 14 d5 0c 12 00 00 	mov    0x120c(,%edx,8),%edx
 ba0:	85 d2                	test   %edx,%edx
 ba2:	74 11                	je     bb5 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
 ba4:	83 ec 0c             	sub    $0xc,%esp
 ba7:	52                   	push   %edx
 ba8:	e8 e3 fa ff ff       	call   690 <free>
 bad:	a1 e0 11 00 00       	mov    0x11e0,%eax
 bb2:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
 bb5:	8d 04 40             	lea    (%eax,%eax,2),%eax
 bb8:	bb 10 12 00 00       	mov    $0x1210,%ebx
 bbd:	c7 04 c5 10 12 00 00 	movl   $0x0,0x1210(,%eax,8)
 bc4:	00 00 00 00 
 bc8:	89 d8                	mov    %ebx,%eax
 bca:	eb 0e                	jmp    bda <uthread_exit+0x5a>
 bcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 bd0:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
 bd3:	3d b8 12 00 00       	cmp    $0x12b8,%eax
 bd8:	74 26                	je     c00 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
 bda:	83 38 03             	cmpl   $0x3,(%eax)
 bdd:	75 f1                	jne    bd0 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
 bdf:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
 be5:	eb e9                	jmp    bd0 <uthread_exit+0x50>
 be7:	89 f6                	mov    %esi,%esi
 be9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 bf0:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
 bf3:	e8 18 fc ff ff       	call   810 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 bf8:	81 fb b8 12 00 00    	cmp    $0x12b8,%ebx
 bfe:	74 11                	je     c11 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
 c00:	8b 03                	mov    (%ebx),%eax
 c02:	85 c0                	test   %eax,%eax
 c04:	75 ea                	jne    bf0 <uthread_exit+0x70>
 c06:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 c09:	81 fb b8 12 00 00    	cmp    $0x12b8,%ebx
 c0f:	75 ef                	jne    c00 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
 ...
 c23:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
 c26:	68 87 0d 00 00       	push   $0xd87
 c2b:	6a 01                	push   $0x1
 c2d:	e8 be f8 ff ff       	call   4f0 <printf>
  alarm(UTHREAD_QUANTA);
 c32:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 c39:	e8 fc f7 ff ff       	call   43a <alarm>
  start_func(arg);
 c3e:	58                   	pop    %eax
 c3f:	ff 75 0c             	pushl  0xc(%ebp)
 c42:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
 c45:	e8 36 ff ff ff       	call   b80 <uthread_exit>
 c4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000c50 <uthred_self>:
...
uthred_self(void)
{
 ...
 c50:	a1 e0 11 00 00       	mov    0x11e0,%eax
  }
}
...
uthred_self(void)
{
 ...
 c56:	89 e5                	mov    %esp,%ebp
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 c58:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
 c5b:	5d                   	pop    %ebp
...
uthred_join(int tid)
{
 ...
 c7a:	39 1d a8 12 00 00    	cmp    %ebx,0x12a8
 c80:	7e 60                	jle    ce2 <uthred_join+0x72>
 c82:	89 d8                	mov    %ebx,%eax
 c84:	c1 e8 1f             	shr    $0x1f,%eax
 c87:	84 c0                	test   %al,%al
 c89:	75 57                	jne    ce2 <uthred_join+0x72>
  }
...
loop:
 ...
 c8e:	6a 00                	push   $0x0
 c90:	e8 a5 f7 ff ff       	call   43a <alarm>
 c95:	b8 00 12 00 00       	mov    $0x1200,%eax
 ...
 ca0:	3b 18                	cmp    (%eax),%ebx
 ca2:	74 24                	je     cc8 <uthred_join+0x58>
 ca4:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 ca7:	3d a8 12 00 00       	cmp    $0x12a8,%eax
 cac:	75 f2                	jne    ca0 <uthred_join+0x30>
 ...
 cb1:	6a 05                	push   $0x5
 cb3:	e8 82 f7 ff ff       	call   43a <alarm>

  return 0;
 cb8:	83 c4 10             	add    $0x10,%esp
 cbb:	31 c0                	xor    %eax,%eax
}
 cbd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 cc0:	c9                   	leave  
 cc1:	c3                   	ret    
 ...
 cc8:	a1 e0 11 00 00       	mov    0x11e0,%eax
 ccd:	8d 04 40             	lea    (%eax,%eax,2),%eax
 cd0:	c7 04 c5 10 12 00 00 	movl   $0x3,0x1210(,%eax,8)
 cd7:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
 cdb:	e8 30 fb ff ff       	call   810 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
 ce0:	eb a9                	jmp    c8b <uthred_join+0x1b>
{
  int i;
  ...
  if(tid >= next_tid || tid < 0) {
    return -1;
 ce2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 ce7:	eb d4                	jmp    cbd <uthred_join+0x4d>
