...
_ulttest:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  11:	68 c0 0c 00 00       	push   $0xcc0
  16:	6a 01                	push   $0x1
  18:	e8 83 04 00 00       	call   4a0 <printf>
	uthread_init();
  1d:	e8 5e 09 00 00       	call   980 <uthread_init>
	uthread_create(FUNCTION1, (void*)100);
  22:	58                   	pop    %eax
  23:	5a                   	pop    %edx
  24:	6a 64                	push   $0x64
  26:	68 60 00 00 00       	push   $0x60
  2b:	e8 f0 09 00 00       	call   a20 <uthread_create>
	uthread_create(FUNCTION2, (void*)100);
  30:	59                   	pop    %ecx
  31:	58                   	pop    %eax
  32:	6a 64                	push   $0x64
  34:	68 90 00 00 00       	push   $0x90
  39:	e8 e2 09 00 00       	call   a20 <uthread_create>
	uthread_create(FUNCTION3, (void*)100);
  3e:	58                   	pop    %eax
  3f:	5a                   	pop    %edx
  40:	6a 64                	push   $0x64
  42:	68 c0 00 00 00       	push   $0xc0
  47:	e8 d4 09 00 00       	call   a20 <uthread_create>
  4c:	83 c4 10             	add    $0x10,%esp
  4f:	eb fe                	jmp    4f <main+0x4f>
  51:	66 90                	xchg   %ax,%ax
  53:	66 90                	xchg   %ax,%ax
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
...
void FUNCTION1(void *arg) {
  ...
  63:	53                   	push   %ebx
  64:	bb e8 03 00 00       	mov    $0x3e8,%ebx
...
void FUNCTION1(void *arg) {
  ...
  85:	75 e9                	jne    70 <FUNCTION1+0x10>
		printf(1, "FUNCTION1 \n");
	}
}
...
void FUNCTION2(void *arg) {
  ...
  93:	53                   	push   %ebx
  94:	bb e8 03 00 00       	mov    $0x3e8,%ebx
...
void FUNCTION2(void *arg) {
  ...
  b5:	75 e9                	jne    a0 <FUNCTION2+0x10>
		printf(1, "FUNCTION2 \n");
	}
}
...
void FUNCTION3(void *arg) {
  ...
  c3:	53                   	push   %ebx
  c4:	bb e8 03 00 00       	mov    $0x3e8,%ebx
  ...
  d3:	68 b4 0c 00 00       	push   $0xcb4
  d8:	6a 01                	push   $0x1
  da:	e8 c1 03 00 00       	call   4a0 <printf>
	}
}
...
void FUNCTION3(void *arg) {
  ...
  e5:	75 e9                	jne    d0 <FUNCTION3+0x10>
		printf(1, "FUNCTION3 \n");
	}
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 e8 0c 00 00 	movzbl 0xce8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 e1 0c 00 00       	mov    $0xce1,%eax
...
free(void *ap)
{
 ...
 641:	a1 e0 11 00 00       	mov    0x11e0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 e0 11 00 00       	mov    %eax,0x11e0
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 e0 11 00 00       	mov    %eax,0x11e0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 e0 11 00 00    	mov    0x11e0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 e0 11 00 00    	cmp    %eax,0x11e0
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 e0 11 00 00    	mov    0x11e0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 e0 11 00 00    	mov    %edx,0x11e0
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 e0 11 00 00 e4 	movl   $0x11e4,0x11e0
 79d:	11 00 00 
 7a0:	c7 05 e4 11 00 00 e4 	movl   $0x11e4,0x11e4
 7a7:	11 00 00 
    base.s.size = 0;
 7aa:	b8 e4 11 00 00       	mov    $0x11e4,%eax
 7af:	c7 05 e8 11 00 00 00 	movl   $0x0,0x11e8
 7b6:	00 00 00 
...
uthread_yield(void)
{
 ...
 7d0:	a1 00 12 00 00       	mov    0x1200,%eax
 7d5:	83 c4 10             	add    $0x10,%esp
 7d8:	8d 14 40             	lea    (%eax,%eax,2),%edx
 7db:	8d 14 d5 20 12 00 00 	lea    0x1220(,%edx,8),%edx
 ...
 7ec:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 7ef:	83 05 00 12 00 00 01 	addl   $0x1,0x1200
 7f6:	bb 30 12 00 00       	mov    $0x1230,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 7fd:	8d 04 c5 20 12 00 00 	lea    0x1220(,%eax,8),%eax
 ...
 804:	c7 05 d0 12 00 00 ff 	movl   $0xffffffff,0x12d0
 80b:	ff ff ff 
 ...
 84b:	83 c6 18             	add    $0x18,%esi
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 84e:	81 fe d8 12 00 00    	cmp    $0x12d8,%esi
...
rand()
{
 ...
 860:	69 05 d4 11 00 00 0d 	imul   $0x19660d,0x11d4,%eax
 867:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
rand()
{
 ...
 87c:	a3 d4 11 00 00       	mov    %eax,0x11d4
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
 ...
 8b4:	89 15 cc 12 00 00    	mov    %edx,0x12cc
 ...
 8d9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 8e0:	a3 00 12 00 00       	mov    %eax,0x1200
 ...
 8e8:	8d 04 c5 20 12 00 00 	lea    0x1220(,%eax,8),%eax
 ...
 94c:	89 3d d0 12 00 00    	mov    %edi,0x12d0
...
{
  randstate = randstate * 1664525 + 1013904223;
 960:	69 05 d4 11 00 00 0d 	imul   $0x19660d,0x11d4,%eax
 967:	66 19 00 
//***************************************************************************************//
...
rand()
{
 ...
 973:	a3 d4 11 00 00       	mov    %eax,0x11d4
  return randstate;
}
 978:	c3                   	ret    
 ...
 uthread_init()
{
 ...
 986:	68 21 0d 00 00       	push   $0xd21
 98b:	6a 01                	push   $0x1
 98d:	e8 0e fb ff ff       	call   4a0 <printf>
 992:	b8 30 12 00 00       	mov    $0x1230,%eax
 ...
 uthread_init()
{
  ...
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 9b0:	3d d8 12 00 00       	cmp    $0x12d8,%eax
 ...
 9b7:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 9ba:	c7 05 c8 12 00 00 01 	movl   $0x1,0x12c8
 9c1:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 9c4:	c7 05 00 12 00 00 00 	movl   $0x0,0x1200
 9cb:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 9d5:	c7 05 20 12 00 00 00 	movl   $0x0,0x1220
 9dc:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 9df:	c7 05 2c 12 00 00 00 	movl   $0x0,0x122c
 9e6:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 9e9:	c7 05 30 12 00 00 01 	movl   $0x1,0x1230
 9f0:	00 00 00 
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 a40:	5b                   	pop    %ebx
 a41:	5e                   	pop    %esi
 a42:	68 6c 0d 00 00       	push   $0xd6c
 a47:	6a 01                	push   $0x1
 a49:	e8 52 fa ff ff       	call   4a0 <printf>
 a4e:	ba 30 12 00 00       	mov    $0x1230,%edx
...
load_t:
 ...
 a90:	8b 15 c8 12 00 00    	mov    0x12c8,%edx
...
load_t:
 ...
 aa4:	89 93 20 12 00 00    	mov    %edx,0x1220(%ebx)
  // update next tid
  next_tid++;
 aaa:	83 c2 01             	add    $0x1,%edx
 aad:	89 15 c8 12 00 00    	mov    %edx,0x12c8
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ...
 ac2:	00 00 00 
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ac5:	89 83 2c 12 00 00    	mov    %eax,0x122c(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 acb:	c7 83 30 12 00 00 02 	movl   $0x2,0x1230(%ebx)
 ad2:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 ad5:	c7 83 24 12 00 00 00 	movl   $0x0,0x1224(%ebx)
 adc:	00 00 00 
  uthread_pool[i].ebp = 0;
 adf:	c7 83 28 12 00 00 00 	movl   $0x0,0x1228(%ebx)
 ae6:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ...
 b0d:	e8 d8 f8 ff ff       	call   3ea <alarm>
  ...
  return uthread_pool[i].tid;
 b12:	8b 83 20 12 00 00    	mov    0x1220(%ebx),%eax
...
uthread_exit(void)
{
 ...
 b3e:	a1 00 12 00 00       	mov    0x1200,%eax
 b43:	83 c4 10             	add    $0x10,%esp
 b46:	8d 14 40             	lea    (%eax,%eax,2),%edx
 b49:	8b 14 d5 2c 12 00 00 	mov    0x122c(,%edx,8),%edx
 ...
 b5d:	a1 00 12 00 00       	mov    0x1200,%eax
 ...
 b68:	bb 30 12 00 00       	mov    $0x1230,%ebx
 b6d:	c7 04 c5 30 12 00 00 	movl   $0x0,0x1230(,%eax,8)
 b74:	00 00 00 00 
 ...
 b80:	83 c0 18             	add    $0x18,%eax
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
 b83:	3d d8 12 00 00       	cmp    $0x12d8,%eax
 ...
 ba3:	e8 18 fc ff ff       	call   7c0 <uthread_yield>
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 ba8:	81 fb d8 12 00 00    	cmp    $0x12d8,%ebx
 ...
 bb6:	83 c3 18             	add    $0x18,%ebx
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 bb9:	81 fb d8 12 00 00    	cmp    $0x12d8,%ebx
...
uthred_self(void)
{
 ...
 c00:	a1 00 12 00 00       	mov    0x1200,%eax
  }
}
...
uthred_self(void)
{
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 c0c:	8b 04 c5 20 12 00 00 	mov    0x1220(,%eax,8),%eax
}
 c13:	c3                   	ret    
...
uthred_join(int tid)
{
 ...
 c2a:	39 1d c8 12 00 00    	cmp    %ebx,0x12c8
...
loop:
 ...
 c45:	b8 20 12 00 00       	mov    $0x1220,%eax
 ...
 c54:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 c57:	3d c8 12 00 00       	cmp    $0x12c8,%eax
 ...
 c78:	a1 00 12 00 00       	mov    0x1200,%eax
 c7d:	8d 04 40             	lea    (%eax,%eax,2),%eax
 c80:	c7 04 c5 30 12 00 00 	movl   $0x3,0x1230(,%eax,8)
 c87:	03 00 00 00 
