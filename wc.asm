...
wc(int fd, char *name)
{
  ...
  f0:	74 3a                	je     12c <wc+0x8c>
      c++;
      if(buf[i] == '\n')
  f2:	0f be 87 60 12 00 00 	movsbl 0x1260(%edi),%eax
        l++;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4cf:	f7 f6                	div    %esi
 4d1:	0f b6 92 6c 0d 00 00 	movzbl 0xd6c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 648:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 64b:	b8 63 0d 00 00       	mov    $0xd63,%eax
...
free(void *ap)
{
 ...
 6d1:	a1 40 12 00 00       	mov    0x1240,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 727:	89 08                	mov    %ecx,(%eax)
  freep = p;
 729:	a3 40 12 00 00       	mov    %eax,0x1240
}
 72e:	5b                   	pop    %ebx
 72f:	5e                   	pop    %esi
 730:	5f                   	pop    %edi
 ...
 74a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 74d:	a3 40 12 00 00       	mov    %eax,0x1240
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 15 40 12 00 00    	mov    0x1240,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7bf:	76 3f                	jbe    800 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	39 05 40 12 00 00    	cmp    %eax,0x1240
 ...
 7e6:	e8 e5 fe ff ff       	call   6d0 <free>
  return freep;
 7eb:	8b 15 40 12 00 00    	mov    0x1240,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 80c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 80f:	89 15 40 12 00 00    	mov    %edx,0x1240
      return (void*)(p + 1);
 ...
 824:	eb e9                	jmp    80f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 826:	c7 05 40 12 00 00 44 	movl   $0x1244,0x1240
 82d:	12 00 00 
 830:	c7 05 44 12 00 00 44 	movl   $0x1244,0x1244
 837:	12 00 00 
    base.s.size = 0;
 83a:	b8 44 12 00 00       	mov    $0x1244,%eax
 83f:	c7 05 48 12 00 00 00 	movl   $0x0,0x1248
 846:	00 00 00 
 849:	e9 3e ff ff ff       	jmp    78c <malloc+0x2c>
 84e:	66 90                	xchg   %ax,%ax

00000850 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
 ...
 856:	83 ec 28             	sub    $0x28,%esp
  ...
  alarm(0);
 859:	6a 00                	push   $0x0
 85b:	e8 1a fc ff ff       	call   47a <alarm>
 ...
 860:	a1 60 14 00 00       	mov    0x1460,%eax
 865:	83 c4 10             	add    $0x10,%esp
 868:	8d 14 40             	lea    (%eax,%eax,2),%edx
 86b:	8d 14 d5 80 14 00 00 	lea    0x1480(,%edx,8),%edx
 872:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
 876:	0f 84 54 01 00 00    	je     9d0 <uthread_yield+0x180>
 ...
 87c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 87f:	83 05 60 14 00 00 01 	addl   $0x1,0x1460
 886:	bb 90 14 00 00       	mov    $0x1490,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
 88b:	89 e2                	mov    %esp,%edx
 88d:	8d 04 c5 80 14 00 00 	lea    0x1480(,%eax,8),%eax
 ...
 894:	c7 05 30 15 00 00 ff 	movl   $0xffffffff,0x1530
 89b:	ff ff ff 
 89e:	89 de                	mov    %ebx,%esi
 8a0:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
 8a4:	bf ff ff ff ff       	mov    $0xffffffff,%edi
 ...
 8ae:	89 50 04             	mov    %edx,0x4(%eax)
  asm("movl %%ebp, %0;" : "=r" (uthread_pool[c_uthread_index].ebp));
 8b1:	89 ea                	mov    %ebp,%edx
 8b3:	89 50 08             	mov    %edx,0x8(%eax)
 ...
 8c4:	0f 95 c2             	setne  %dl
 8c7:	83 f8 03             	cmp    $0x3,%eax
 8ca:	0f 95 c0             	setne  %al
 8cd:	20 d0                	and    %dl,%al
 8cf:	74 0a                	je     8db <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
 8d1:	8b 7e 04             	mov    0x4(%esi),%edi
 8d4:	88 45 e7             	mov    %al,-0x19(%ebp)
 8d7:	01 cf                	add    %ecx,%edi
 8d9:	89 f9                	mov    %edi,%ecx
 8db:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 8de:	81 fe 38 15 00 00    	cmp    $0x1538,%esi
 8e4:	75 da                	jne    8c0 <uthread_yield+0x70>
 8e6:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
 8ea:	0f 85 ec 00 00 00    	jne    9dc <uthread_yield+0x18c>
...
rand()
{
 ...
 8f0:	69 05 28 12 00 00 0d 	imul   $0x19660d,0x1228,%eax
 8f7:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
 907:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 90c:	a3 28 12 00 00       	mov    %eax,0x1228
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
  ...
  randomTicket = rand() % current_ticket_num;
 911:	f7 f1                	div    %ecx
 913:	89 d6                	mov    %edx,%esi

  printf(1,"current_ticket_num=%d\n", current_ticket_num);
 915:	e8 16 fc ff ff       	call   530 <printf>
  printf(1,"randomTicket=%d\n", randomTicket);
 91a:	83 c4 0c             	add    $0xc,%esp
 91d:	56                   	push   %esi
 91e:	68 94 0d 00 00       	push   $0xd94
 923:	6a 01                	push   $0x1
 925:	e8 06 fc ff ff       	call   530 <printf>

  // set the choosen order thread to run
  choosen = randomTicket / NTICKET;
 92a:	89 f0                	mov    %esi,%eax
 92c:	ba 67 66 66 66       	mov    $0x66666667,%edx
 931:	c1 fe 1f             	sar    $0x1f,%esi
 934:	f7 ea                	imul   %edx
 936:	83 c4 10             	add    $0x10,%esp

  // pick the index of choosen thread
  int chooseCount = -1;
 939:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  for(j = 0; j < MAX_THREADS; ++j) {
 93e:	31 c0                	xor    %eax,%eax
 ...
 944:	89 15 2c 15 00 00    	mov    %edx,0x152c
 94a:	eb 0f                	jmp    95b <uthread_yield+0x10b>
 ...
 953:	83 c3 18             	add    $0x18,%ebx
 956:	83 f8 07             	cmp    $0x7,%eax
 959:	74 15                	je     970 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
 95b:	83 3b 02             	cmpl   $0x2,(%ebx)
 95e:	75 f0                	jne    950 <uthread_yield+0x100>
      chooseCount++;
 960:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
 963:	39 ca                	cmp    %ecx,%edx
 965:	75 e9                	jne    950 <uthread_yield+0x100>
 ...
 969:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 970:	a3 60 14 00 00       	mov    %eax,0x1460

  // ****************************************************************** //

  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
 975:	8d 04 40             	lea    (%eax,%eax,2),%eax
 978:	8d 04 c5 80 14 00 00 	lea    0x1480(,%eax,8),%eax
 ...
 9b0:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
 9b2:	8b 40 08             	mov    0x8(%eax),%eax
 9b5:	89 c5                	mov    %eax,%ebp

    // reset alarm
    alarm(UTHREAD_QUANTA);
 9b7:	83 ec 0c             	sub    $0xc,%esp
 9ba:	6a 05                	push   $0x5
 9bc:	e8 b9 fa ff ff       	call   47a <alarm>
 ...
 9cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
 9d0:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
 9d7:	e9 a0 fe ff ff       	jmp    87c <uthread_yield+0x2c>
 9dc:	89 3d 30 15 00 00    	mov    %edi,0x1530
 9e2:	e9 09 ff ff ff       	jmp    8f0 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
 9f0:	69 05 28 12 00 00 0d 	imul   $0x19660d,0x1228,%eax
 9f7:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
 9fe:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 a03:	a3 28 12 00 00       	mov    %eax,0x1228
  return randstate;
}
 a08:	c3                   	ret    
 a09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000a10 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
 ...
 a13:	83 ec 10             	sub    $0x10,%esp
  printf(1, "** INIT USER LEVEL THREAD **\n");
 a16:	68 a5 0d 00 00       	push   $0xda5
 a1b:	6a 01                	push   $0x1
 a1d:	e8 0e fb ff ff       	call   530 <printf>
 a22:	b8 90 14 00 00       	mov    $0x1490,%eax
 ...
 a30:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
 a36:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
 a3d:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 a40:	3d 38 15 00 00       	cmp    $0x1538,%eax
 a45:	75 e9                	jne    a30 <uthread_init+0x20>
 ...
 a47:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 a4a:	c7 05 28 15 00 00 01 	movl   $0x1,0x1528
 a51:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 a54:	c7 05 60 14 00 00 00 	movl   $0x0,0x1460
 a5b:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 a65:	c7 05 80 14 00 00 00 	movl   $0x0,0x1480
 a6c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 a6f:	c7 05 8c 14 00 00 00 	movl   $0x0,0x148c
 a76:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 a79:	c7 05 90 14 00 00 01 	movl   $0x1,0x1490
 a80:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 a83:	e8 da f9 ff ff       	call   462 <signal>
 a88:	83 c4 10             	add    $0x10,%esp
 a8b:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
 a8d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 a92:	75 0f                	jne    aa3 <uthread_init+0x93>
    // case signal error
    return -1;
  }
 ...
 a97:	6a 05                	push   $0x5
 a99:	e8 dc f9 ff ff       	call   47a <alarm>
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 ab8:	68 c3 0d 00 00       	push   $0xdc3
 abd:	6a 01                	push   $0x1
 abf:	e8 6c fa ff ff       	call   530 <printf>
  ...
  alarm(0);
 ac4:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 acb:	e8 aa f9 ff ff       	call   47a <alarm>

  printf(1, "uthread_create after alarm(0) \n");
 ad0:	5b                   	pop    %ebx
 ad1:	5e                   	pop    %esi
 ad2:	68 f0 0d 00 00       	push   $0xdf0
 ad7:	6a 01                	push   $0x1
 ad9:	e8 52 fa ff ff       	call   530 <printf>
 ade:	ba 90 14 00 00       	mov    $0x1490,%edx
 ...
 af0:	8b 0a                	mov    (%edx),%ecx
 af2:	85 c9                	test   %ecx,%ecx
 af4:	74 2a                	je     b20 <uthread_create+0x70>
  alarm(0);
 ...
 af9:	83 c2 18             	add    $0x18,%edx
 afc:	83 f8 07             	cmp    $0x7,%eax
 aff:	75 ef                	jne    af0 <uthread_create+0x40>
    }
  }
 ...
 b04:	6a 05                	push   $0x5
 b06:	e8 6f f9 ff ff       	call   47a <alarm>
  return -1;
 ...
 b0e:	8d 65 f8             	lea    -0x8(%ebp),%esp
  ...
  alarm(UTHREAD_QUANTA);
  return -1;
 b11:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  // enable thread switching
  printf(1, "creation method: returning.. \n");
  alarm(UTHREAD_QUANTA);
...
load_t:
 ...
 b20:	8b 15 28 15 00 00    	mov    0x1528,%edx
 b26:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
 ...
 b2c:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
 b31:	c1 e3 03             	shl    $0x3,%ebx
 b34:	89 93 80 14 00 00    	mov    %edx,0x1480(%ebx)
  // update next tid
  next_tid++;
 b3a:	83 c2 01             	add    $0x1,%edx
 b3d:	89 15 28 15 00 00    	mov    %edx,0x1528
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 b43:	e8 18 fc ff ff       	call   760 <malloc>
 ...
 b48:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
 b4b:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 b52:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 b55:	89 83 8c 14 00 00    	mov    %eax,0x148c(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 b5b:	c7 83 90 14 00 00 02 	movl   $0x2,0x1490(%ebx)
 b62:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 b65:	c7 83 84 14 00 00 00 	movl   $0x0,0x1484(%ebx)
 b6c:	00 00 00 
  uthread_pool[i].ebp = 0;
 b6f:	c7 83 88 14 00 00 00 	movl   $0x0,0x1488(%ebx)
 b76:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 b79:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
 b7f:	8b 55 0c             	mov    0xc(%ebp),%edx
 b82:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
 ...
 b88:	58                   	pop    %eax
 b89:	5a                   	pop    %edx
 b8a:	68 10 0e 00 00       	push   $0xe10
 b8f:	6a 01                	push   $0x1
 b91:	e8 9a f9 ff ff       	call   530 <printf>
  alarm(UTHREAD_QUANTA);
 b96:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 b9d:	e8 d8 f8 ff ff       	call   47a <alarm>

  return uthread_pool[i].tid;
 ba2:	8b 83 80 14 00 00    	mov    0x1480(%ebx),%eax
...
uthread_exit(void)
{
 ...
 bc4:	83 ec 10             	sub    $0x10,%esp
  ...
  alarm(0);
 bc7:	6a 00                	push   $0x0
 bc9:	e8 ac f8 ff ff       	call   47a <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
 bce:	a1 60 14 00 00       	mov    0x1460,%eax
 bd3:	83 c4 10             	add    $0x10,%esp
 bd6:	8d 14 40             	lea    (%eax,%eax,2),%edx
 bd9:	8b 14 d5 8c 14 00 00 	mov    0x148c(,%edx,8),%edx
 be0:	85 d2                	test   %edx,%edx
 be2:	74 11                	je     bf5 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
 be4:	83 ec 0c             	sub    $0xc,%esp
 be7:	52                   	push   %edx
 be8:	e8 e3 fa ff ff       	call   6d0 <free>
 bed:	a1 60 14 00 00       	mov    0x1460,%eax
 bf2:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
 bf5:	8d 04 40             	lea    (%eax,%eax,2),%eax
 bf8:	bb 90 14 00 00       	mov    $0x1490,%ebx
 bfd:	c7 04 c5 90 14 00 00 	movl   $0x0,0x1490(,%eax,8)
 c04:	00 00 00 00 
 c08:	89 d8                	mov    %ebx,%eax
 c0a:	eb 0e                	jmp    c1a <uthread_exit+0x5a>
 c0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 c10:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
 c13:	3d 38 15 00 00       	cmp    $0x1538,%eax
 c18:	74 26                	je     c40 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
 c1a:	83 38 03             	cmpl   $0x3,(%eax)
 c1d:	75 f1                	jne    c10 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
 c1f:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
 c25:	eb e9                	jmp    c10 <uthread_exit+0x50>
 c27:	89 f6                	mov    %esi,%esi
 c29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 c30:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
 c33:	e8 18 fc ff ff       	call   850 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 c38:	81 fb 38 15 00 00    	cmp    $0x1538,%ebx
 c3e:	74 11                	je     c51 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
 c40:	8b 03                	mov    (%ebx),%eax
 c42:	85 c0                	test   %eax,%eax
 c44:	75 ea                	jne    c30 <uthread_exit+0x70>
 c46:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 c49:	81 fb 38 15 00 00    	cmp    $0x1538,%ebx
 c4f:	75 ef                	jne    c40 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
 ...
 c63:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
 c66:	68 db 0d 00 00       	push   $0xddb
 c6b:	6a 01                	push   $0x1
 c6d:	e8 be f8 ff ff       	call   530 <printf>
  alarm(UTHREAD_QUANTA);
 c72:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 c79:	e8 fc f7 ff ff       	call   47a <alarm>
  start_func(arg);
 c7e:	58                   	pop    %eax
 c7f:	ff 75 0c             	pushl  0xc(%ebp)
 c82:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
 c85:	e8 36 ff ff ff       	call   bc0 <uthread_exit>
 c8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000c90 <uthred_self>:
...
uthred_self(void)
{
 ...
 c90:	a1 60 14 00 00       	mov    0x1460,%eax
  }
}
...
uthred_self(void)
{
 ...
 c96:	89 e5                	mov    %esp,%ebp
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 c98:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
 c9b:	5d                   	pop    %ebp
...
uthred_join(int tid)
{
 ...
 cba:	39 1d 28 15 00 00    	cmp    %ebx,0x1528
 cc0:	7e 60                	jle    d22 <uthred_join+0x72>
 cc2:	89 d8                	mov    %ebx,%eax
 cc4:	c1 e8 1f             	shr    $0x1f,%eax
 cc7:	84 c0                	test   %al,%al
 cc9:	75 57                	jne    d22 <uthred_join+0x72>
  }
...
loop:
 ...
 cce:	6a 00                	push   $0x0
 cd0:	e8 a5 f7 ff ff       	call   47a <alarm>
 cd5:	b8 80 14 00 00       	mov    $0x1480,%eax
 ...
 ce0:	3b 18                	cmp    (%eax),%ebx
 ce2:	74 24                	je     d08 <uthred_join+0x58>
 ce4:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 ce7:	3d 28 15 00 00       	cmp    $0x1528,%eax
 cec:	75 f2                	jne    ce0 <uthred_join+0x30>
 ...
 cf1:	6a 05                	push   $0x5
 cf3:	e8 82 f7 ff ff       	call   47a <alarm>

  return 0;
 cf8:	83 c4 10             	add    $0x10,%esp
 cfb:	31 c0                	xor    %eax,%eax
}
 cfd:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 d00:	c9                   	leave  
 d01:	c3                   	ret    
 ...
 d08:	a1 60 14 00 00       	mov    0x1460,%eax
 d0d:	8d 04 40             	lea    (%eax,%eax,2),%eax
 d10:	c7 04 c5 90 14 00 00 	movl   $0x3,0x1490(,%eax,8)
 d17:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
 d1b:	e8 30 fb ff ff       	call   850 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
 d20:	eb a9                	jmp    ccb <uthred_join+0x1b>
{
  int i;
  ...
  if(tid >= next_tid || tid < 0) {
    return -1;
 d22:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 d27:	eb d4                	jmp    cfd <uthred_join+0x4d>
