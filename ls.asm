...
printint(int fd, int xx, int base, int sgn)
{
 ...
 68f:	f7 f6                	div    %esi
 691:	0f b6 92 40 0f 00 00 	movzbl 0xf40(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 808:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 80b:	b8 36 0f 00 00       	mov    $0xf36,%eax
...
free(void *ap)
{
 ...
 891:	a1 50 14 00 00       	mov    0x1450,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8e9:	a3 50 14 00 00       	mov    %eax,0x1450
}
 8ee:	5b                   	pop    %ebx
 8ef:	5e                   	pop    %esi
 8f0:	5f                   	pop    %edi
 ...
 90a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 90d:	a3 50 14 00 00       	mov    %eax,0x1450
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 929:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 92c:	8b 15 50 14 00 00    	mov    0x1450,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 97f:	76 3f                	jbe    9c0 <malloc+0xa0>
    ...
    if(p == freep)
 981:	39 05 50 14 00 00    	cmp    %eax,0x1450
 ...
 9a6:	e8 e5 fe ff ff       	call   890 <free>
  return freep;
 9ab:	8b 15 50 14 00 00    	mov    0x1450,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 9cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 9cf:	89 15 50 14 00 00    	mov    %edx,0x1450
      return (void*)(p + 1);
 ...
 9e4:	eb e9                	jmp    9cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9e6:	c7 05 50 14 00 00 54 	movl   $0x1454,0x1450
 9ed:	14 00 00 
 9f0:	c7 05 54 14 00 00 54 	movl   $0x1454,0x1454
 9f7:	14 00 00 
    base.s.size = 0;
 9fa:	b8 54 14 00 00       	mov    $0x1454,%eax
 9ff:	c7 05 58 14 00 00 00 	movl   $0x0,0x1458
 a06:	00 00 00 
 a09:	e9 3e ff ff ff       	jmp    94c <malloc+0x2c>
 a0e:	66 90                	xchg   %ax,%ax

00000a10 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
 ...
 a16:	83 ec 28             	sub    $0x28,%esp
  ...
  alarm(0);
 a19:	6a 00                	push   $0x0
 a1b:	e8 1a fc ff ff       	call   63a <alarm>
 ...
 a20:	a1 60 14 00 00       	mov    0x1460,%eax
 a25:	83 c4 10             	add    $0x10,%esp
 a28:	8d 14 40             	lea    (%eax,%eax,2),%edx
 a2b:	8d 14 d5 80 14 00 00 	lea    0x1480(,%edx,8),%edx
 a32:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
 a36:	0f 84 54 01 00 00    	je     b90 <uthread_yield+0x180>
 ...
 a3c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 a3f:	83 05 60 14 00 00 01 	addl   $0x1,0x1460
 a46:	bb 90 14 00 00       	mov    $0x1490,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
  ...
  // save current thread esp and ebp
  asm("movl %%esp, %0;" : "=r" (uthread_pool[c_uthread_index].esp));
 a4b:	89 e2                	mov    %esp,%edx
 a4d:	8d 04 c5 80 14 00 00 	lea    0x1480(,%eax,8),%eax
 ...
 a54:	c7 05 30 15 00 00 ff 	movl   $0xffffffff,0x1530
 a5b:	ff ff ff 
 a5e:	89 de                	mov    %ebx,%esi
 a60:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
 a64:	bf ff ff ff ff       	mov    $0xffffffff,%edi
 a69:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 a6e:	89 50 04             	mov    %edx,0x4(%eax)
  asm("movl %%ebp, %0;" : "=r" (uthread_pool[c_uthread_index].ebp));
 a71:	89 ea                	mov    %ebp,%edx
 a73:	89 50 08             	mov    %edx,0x8(%eax)
 ...
 a80:	8b 06                	mov    (%esi),%eax
 a82:	85 c0                	test   %eax,%eax
 a84:	0f 95 c2             	setne  %dl
 a87:	83 f8 03             	cmp    $0x3,%eax
 a8a:	0f 95 c0             	setne  %al
 a8d:	20 d0                	and    %dl,%al
 a8f:	74 0a                	je     a9b <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
 a91:	8b 7e 04             	mov    0x4(%esi),%edi
 a94:	88 45 e7             	mov    %al,-0x19(%ebp)
 a97:	01 cf                	add    %ecx,%edi
 a99:	89 f9                	mov    %edi,%ecx
 a9b:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 a9e:	81 fe 38 15 00 00    	cmp    $0x1538,%esi
 aa4:	75 da                	jne    a80 <uthread_yield+0x70>
 aa6:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
 aaa:	0f 85 ec 00 00 00    	jne    b9c <uthread_yield+0x18c>
...
rand()
{
 ...
 ab0:	69 05 34 14 00 00 0d 	imul   $0x19660d,0x1434,%eax
 ab7:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
 ac7:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 acc:	a3 34 14 00 00       	mov    %eax,0x1434
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
 ...
 ad3:	89 d6                	mov    %edx,%esi
  ...
  printf(1,"current_ticket_num=%d\n", current_ticket_num);
 ad5:	e8 16 fc ff ff       	call   6f0 <printf>
  printf(1,"randomTicket=%d\n", randomTicket);
 ada:	83 c4 0c             	add    $0xc,%esp
 add:	56                   	push   %esi
 ade:	68 68 0f 00 00       	push   $0xf68
 ae3:	6a 01                	push   $0x1
 ae5:	e8 06 fc ff ff       	call   6f0 <printf>

  // set the choosen order thread to run
  choosen = randomTicket / NTICKET;
 aea:	89 f0                	mov    %esi,%eax
 aec:	ba 67 66 66 66       	mov    $0x66666667,%edx
 af1:	c1 fe 1f             	sar    $0x1f,%esi
 af4:	f7 ea                	imul   %edx
 af6:	83 c4 10             	add    $0x10,%esp

  // pick the index of choosen thread
  int chooseCount = -1;
 af9:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  for(j = 0; j < MAX_THREADS; ++j) {
 afe:	31 c0                	xor    %eax,%eax
  ...
  choosen = randomTicket / NTICKET;
 b00:	d1 fa                	sar    %edx
 b02:	29 f2                	sub    %esi,%edx
 b04:	89 15 2c 15 00 00    	mov    %edx,0x152c
 b0a:	eb 0f                	jmp    b1b <uthread_yield+0x10b>
 ...
 b13:	83 c3 18             	add    $0x18,%ebx
 b16:	83 f8 07             	cmp    $0x7,%eax
 b19:	74 15                	je     b30 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
 b1b:	83 3b 02             	cmpl   $0x2,(%ebx)
 b1e:	75 f0                	jne    b10 <uthread_yield+0x100>
      chooseCount++;
 b20:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
 b23:	39 ca                	cmp    %ecx,%edx
 b25:	75 e9                	jne    b10 <uthread_yield+0x100>
 ...
 b29:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 b30:	a3 60 14 00 00       	mov    %eax,0x1460

  // ****************************************************************** //

  // current switched thread is move to RUNNING mode, next to be execute
  uthread_pool[c_uthread_index].state = RUNNING;
 b35:	8d 04 40             	lea    (%eax,%eax,2),%eax
 b38:	8d 04 c5 80 14 00 00 	lea    0x1480(,%eax,8),%eax
 ...
 b70:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
 b72:	8b 40 08             	mov    0x8(%eax),%eax
 b75:	89 c5                	mov    %eax,%ebp

    // reset alarm
    alarm(UTHREAD_QUANTA);
 b77:	83 ec 0c             	sub    $0xc,%esp
 b7a:	6a 05                	push   $0x5
 b7c:	e8 b9 fa ff ff       	call   63a <alarm>
 ...
 b8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
 b90:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
 b97:	e9 a0 fe ff ff       	jmp    a3c <uthread_yield+0x2c>
 b9c:	89 3d 30 15 00 00    	mov    %edi,0x1530
 ba2:	e9 09 ff ff ff       	jmp    ab0 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
 bb0:	69 05 34 14 00 00 0d 	imul   $0x19660d,0x1434,%eax
 bb7:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
 bbe:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 bc3:	a3 34 14 00 00       	mov    %eax,0x1434
  return randstate;
}
 bc8:	c3                   	ret    
 bc9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000bd0 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
 ...
 bd6:	68 79 0f 00 00       	push   $0xf79
 bdb:	6a 01                	push   $0x1
 bdd:	e8 0e fb ff ff       	call   6f0 <printf>
 be2:	b8 90 14 00 00       	mov    $0x1490,%eax
 ...
 bf0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
 bf6:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
 bfd:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 c00:	3d 38 15 00 00       	cmp    $0x1538,%eax
 c05:	75 e9                	jne    bf0 <uthread_init+0x20>
 ...
 c07:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 c0a:	c7 05 28 15 00 00 01 	movl   $0x1,0x1528
 c11:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 c14:	c7 05 60 14 00 00 00 	movl   $0x0,0x1460
 c1b:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 c25:	c7 05 80 14 00 00 00 	movl   $0x0,0x1480
 c2c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 c2f:	c7 05 8c 14 00 00 00 	movl   $0x0,0x148c
 c36:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 c39:	c7 05 90 14 00 00 01 	movl   $0x1,0x1490
 c40:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 c43:	e8 da f9 ff ff       	call   622 <signal>
 c48:	83 c4 10             	add    $0x10,%esp
 c4b:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
 c4d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 c52:	75 0f                	jne    c63 <uthread_init+0x93>
    // case signal error
    return -1;
  }
 ...
 c57:	6a 05                	push   $0x5
 c59:	e8 dc f9 ff ff       	call   63a <alarm>
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 c78:	68 97 0f 00 00       	push   $0xf97
 c7d:	6a 01                	push   $0x1
 c7f:	e8 6c fa ff ff       	call   6f0 <printf>
  ...
  alarm(0);
 c84:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 c8b:	e8 aa f9 ff ff       	call   63a <alarm>

  printf(1, "uthread_create after alarm(0) \n");
 c90:	5b                   	pop    %ebx
 c91:	5e                   	pop    %esi
 c92:	68 c4 0f 00 00       	push   $0xfc4
 c97:	6a 01                	push   $0x1
 c99:	e8 52 fa ff ff       	call   6f0 <printf>
 c9e:	ba 90 14 00 00       	mov    $0x1490,%edx
 ...
 cb2:	85 c9                	test   %ecx,%ecx
 cb4:	74 2a                	je     ce0 <uthread_create+0x70>
  alarm(0);
  ...
  // search for free thread to load
  for(i = 0; i < MAX_THREADS; ++i) {
 cb6:	83 c0 01             	add    $0x1,%eax
 cb9:	83 c2 18             	add    $0x18,%edx
 cbc:	83 f8 07             	cmp    $0x7,%eax
 cbf:	75 ef                	jne    cb0 <uthread_create+0x40>
    }
  }
 ...
 cc4:	6a 05                	push   $0x5
 cc6:	e8 6f f9 ff ff       	call   63a <alarm>
  return -1;
...
load_t:
 ...
 ce0:	8b 15 28 15 00 00    	mov    0x1528,%edx
 ce6:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
 ...
 cec:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
 cf1:	c1 e3 03             	shl    $0x3,%ebx
 cf4:	89 93 80 14 00 00    	mov    %edx,0x1480(%ebx)
  // update next tid
  next_tid++;
 cfa:	83 c2 01             	add    $0x1,%edx
 cfd:	89 15 28 15 00 00    	mov    %edx,0x1528
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 d03:	e8 18 fc ff ff       	call   920 <malloc>
 ...
 d08:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
 d0b:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 d12:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 d15:	89 83 8c 14 00 00    	mov    %eax,0x148c(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 d1b:	c7 83 90 14 00 00 02 	movl   $0x2,0x1490(%ebx)
 d22:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 d25:	c7 83 84 14 00 00 00 	movl   $0x0,0x1484(%ebx)
 d2c:	00 00 00 
  uthread_pool[i].ebp = 0;
 d2f:	c7 83 88 14 00 00 00 	movl   $0x0,0x1488(%ebx)
 d36:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 d39:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
 d3f:	8b 55 0c             	mov    0xc(%ebp),%edx
 d42:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
 ...
 d48:	58                   	pop    %eax
 d49:	5a                   	pop    %edx
 d4a:	68 e4 0f 00 00       	push   $0xfe4
 d4f:	6a 01                	push   $0x1
 d51:	e8 9a f9 ff ff       	call   6f0 <printf>
  alarm(UTHREAD_QUANTA);
 d56:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 d5d:	e8 d8 f8 ff ff       	call   63a <alarm>

  return uthread_pool[i].tid;
 d62:	8b 83 80 14 00 00    	mov    0x1480(%ebx),%eax
 d68:	83 c4 10             	add    $0x10,%esp
}
 d6b:	8d 65 f8             	lea    -0x8(%ebp),%esp
 d6e:	5b                   	pop    %ebx
 d6f:	5e                   	pop    %esi
 d70:	5d                   	pop    %ebp
 d71:	c3                   	ret    
 d72:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 d79:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi

00000d80 <uthread_exit>:
...
uthread_exit(void)
{
 ...
 d84:	83 ec 10             	sub    $0x10,%esp
  ...
  alarm(0);
 d87:	6a 00                	push   $0x0
 d89:	e8 ac f8 ff ff       	call   63a <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
 d8e:	a1 60 14 00 00       	mov    0x1460,%eax
 d93:	83 c4 10             	add    $0x10,%esp
 d96:	8d 14 40             	lea    (%eax,%eax,2),%edx
 d99:	8b 14 d5 8c 14 00 00 	mov    0x148c(,%edx,8),%edx
 da0:	85 d2                	test   %edx,%edx
 da2:	74 11                	je     db5 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
 da4:	83 ec 0c             	sub    $0xc,%esp
 da7:	52                   	push   %edx
 da8:	e8 e3 fa ff ff       	call   890 <free>
 dad:	a1 60 14 00 00       	mov    0x1460,%eax
 db2:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
 db5:	8d 04 40             	lea    (%eax,%eax,2),%eax
 db8:	bb 90 14 00 00       	mov    $0x1490,%ebx
 dbd:	c7 04 c5 90 14 00 00 	movl   $0x0,0x1490(,%eax,8)
 dc4:	00 00 00 00 
 dc8:	89 d8                	mov    %ebx,%eax
 dca:	eb 0e                	jmp    dda <uthread_exit+0x5a>
 dcc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 dd0:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
 dd3:	3d 38 15 00 00       	cmp    $0x1538,%eax
 dd8:	74 26                	je     e00 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
 dda:	83 38 03             	cmpl   $0x3,(%eax)
 ddd:	75 f1                	jne    dd0 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
 ddf:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
 de5:	eb e9                	jmp    dd0 <uthread_exit+0x50>
 de7:	89 f6                	mov    %esi,%esi
 de9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 df0:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
 df3:	e8 18 fc ff ff       	call   a10 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 df8:	81 fb 38 15 00 00    	cmp    $0x1538,%ebx
 dfe:	74 11                	je     e11 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
 e00:	8b 03                	mov    (%ebx),%eax
 e02:	85 c0                	test   %eax,%eax
 e04:	75 ea                	jne    df0 <uthread_exit+0x70>
 e06:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 e09:	81 fb 38 15 00 00    	cmp    $0x1538,%ebx
 e0f:	75 ef                	jne    e00 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
 ...
 e23:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
 e26:	68 af 0f 00 00       	push   $0xfaf
 e2b:	6a 01                	push   $0x1
 e2d:	e8 be f8 ff ff       	call   6f0 <printf>
  alarm(UTHREAD_QUANTA);
 e32:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 e39:	e8 fc f7 ff ff       	call   63a <alarm>
  start_func(arg);
 e3e:	58                   	pop    %eax
 e3f:	ff 75 0c             	pushl  0xc(%ebp)
 e42:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
 e45:	e8 36 ff ff ff       	call   d80 <uthread_exit>
 e4a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000e50 <uthred_self>:
...
uthred_self(void)
{
 ...
 e50:	a1 60 14 00 00       	mov    0x1460,%eax
  }
}
...
uthred_self(void)
{
 ...
 e56:	89 e5                	mov    %esp,%ebp
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 e58:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
 e5b:	5d                   	pop    %ebp
...
uthred_join(int tid)
{
 ...
 e7a:	39 1d 28 15 00 00    	cmp    %ebx,0x1528
 e80:	7e 60                	jle    ee2 <uthred_join+0x72>
 e82:	89 d8                	mov    %ebx,%eax
 e84:	c1 e8 1f             	shr    $0x1f,%eax
 e87:	84 c0                	test   %al,%al
 e89:	75 57                	jne    ee2 <uthred_join+0x72>
  }
...
loop:
 ...
 e8e:	6a 00                	push   $0x0
 e90:	e8 a5 f7 ff ff       	call   63a <alarm>
 e95:	b8 80 14 00 00       	mov    $0x1480,%eax
 ...
 ea0:	3b 18                	cmp    (%eax),%ebx
 ea2:	74 24                	je     ec8 <uthred_join+0x58>
 ea4:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 ea7:	3d 28 15 00 00       	cmp    $0x1528,%eax
 eac:	75 f2                	jne    ea0 <uthred_join+0x30>
 ...
 eb1:	6a 05                	push   $0x5
 eb3:	e8 82 f7 ff ff       	call   63a <alarm>
 ...
 ec8:	a1 60 14 00 00       	mov    0x1460,%eax
 ecd:	8d 04 40             	lea    (%eax,%eax,2),%eax
 ed0:	c7 04 c5 90 14 00 00 	movl   $0x3,0x1490(,%eax,8)
 ed7:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
 edb:	e8 30 fb ff ff       	call   a10 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
 ee0:	eb a9                	jmp    e8b <uthred_join+0x1b>
{
  int i;
 ...
 ee7:	eb d4                	jmp    ebd <uthred_join+0x4d>
