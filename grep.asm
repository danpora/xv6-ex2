...
grep(char *pattern, int fd)
{
 ...
 245:	50                   	push   %eax
 246:	8d 81 c0 14 00 00    	lea    0x14c0(%ecx),%eax
 24c:	50                   	push   %eax
 ...
 260:	01 45 e4             	add    %eax,-0x1c(%ebp)
    buf[m] = '\0';
    p = buf;
 263:	bb c0 14 00 00       	mov    $0x14c0,%ebx
  int n, m;
  char *p, *q;
 ...
 268:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    buf[m] = '\0';
 26b:	c6 82 c0 14 00 00 00 	movb   $0x0,0x14c0(%edx)
 ...
 2c5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    if(p == buf)
 2c8:	81 fb c0 14 00 00    	cmp    $0x14c0,%ebx
 ...
 2dd:	83 ec 04             	sub    $0x4,%esp
    ...
    if(m > 0){
      m -= p - buf;
 2e0:	2d c0 14 00 00       	sub    $0x14c0,%eax
 2e5:	29 45 e4             	sub    %eax,-0x1c(%ebp)
 2e8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
      memmove(buf, p, m);
 2eb:	51                   	push   %ecx
 2ec:	53                   	push   %ebx
 2ed:	68 c0 14 00 00       	push   $0x14c0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66f:	f7 f6                	div    %esi
 671:	0f b6 92 0c 0f 00 00 	movzbl 0xf0c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 7e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 7eb:	b8 02 0f 00 00       	mov    $0xf02,%eax
...
free(void *ap)
{
 ...
 871:	a1 a0 14 00 00       	mov    0x14a0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 8c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 8c9:	a3 a0 14 00 00       	mov    %eax,0x14a0
}
 8ce:	5b                   	pop    %ebx
 8cf:	5e                   	pop    %esi
 8d0:	5f                   	pop    %edi
 ...
 8ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 8ed:	a3 a0 14 00 00       	mov    %eax,0x14a0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 909:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 90c:	8b 15 a0 14 00 00    	mov    0x14a0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 95f:	76 3f                	jbe    9a0 <malloc+0xa0>
    ...
    if(p == freep)
 961:	39 05 a0 14 00 00    	cmp    %eax,0x14a0
 ...
 986:	e8 e5 fe ff ff       	call   870 <free>
  return freep;
 98b:	8b 15 a0 14 00 00    	mov    0x14a0,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 9ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 9af:	89 15 a0 14 00 00    	mov    %edx,0x14a0
      return (void*)(p + 1);
 ...
 9c4:	eb e9                	jmp    9af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 9c6:	c7 05 a0 14 00 00 a4 	movl   $0x14a4,0x14a0
 9cd:	14 00 00 
 9d0:	c7 05 a4 14 00 00 a4 	movl   $0x14a4,0x14a4
 9d7:	14 00 00 
    base.s.size = 0;
 9da:	b8 a4 14 00 00       	mov    $0x14a4,%eax
 9df:	c7 05 a8 14 00 00 00 	movl   $0x0,0x14a8
 9e6:	00 00 00 
 9e9:	e9 3e ff ff ff       	jmp    92c <malloc+0x2c>
 9ee:	66 90                	xchg   %ax,%ax

000009f0 <uthread_yield>:
  exit();
}
...
uthread_yield(void)
{
 ...
 9f6:	83 ec 28             	sub    $0x28,%esp
  ...
  alarm(0);
 9f9:	6a 00                	push   $0x0
 9fb:	e8 1a fc ff ff       	call   61a <alarm>
 ...
 a00:	a1 c0 18 00 00       	mov    0x18c0,%eax
 a05:	83 c4 10             	add    $0x10,%esp
 a08:	8d 14 40             	lea    (%eax,%eax,2),%edx
 a0b:	8d 14 d5 e0 18 00 00 	lea    0x18e0(,%edx,8),%edx
 a12:	83 7a 10 01          	cmpl   $0x1,0x10(%edx)
 a16:	0f 84 54 01 00 00    	je     b70 <uthread_yield+0x180>
 ...
 a1c:	8d 04 40             	lea    (%eax,%eax,2),%eax
  ...
  c_uthread_index++;
 a1f:	83 05 c0 18 00 00 01 	addl   $0x1,0x18c0
 a26:	bb f0 18 00 00       	mov    $0x18f0,%ebx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 a2d:	8d 04 c5 e0 18 00 00 	lea    0x18e0(,%eax,8),%eax
 ...
 a34:	c7 05 90 19 00 00 ff 	movl   $0xffffffff,0x1990
 a3b:	ff ff ff 
 a3e:	89 de                	mov    %ebx,%esi
 a40:	c6 45 e7 00          	movb   $0x0,-0x19(%ebp)
 a44:	bf ff ff ff ff       	mov    $0xffffffff,%edi
 a49:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
  }
 ...
 a4e:	89 50 04             	mov    %edx,0x4(%eax)
  asm("movl %%ebp, %0;" : "=r" (uthread_pool[c_uthread_index].ebp));
 a51:	89 ea                	mov    %ebp,%edx
 a53:	89 50 08             	mov    %edx,0x8(%eax)
 ...
 a64:	0f 95 c2             	setne  %dl
 a67:	83 f8 03             	cmp    $0x3,%eax
 a6a:	0f 95 c0             	setne  %al
 a6d:	20 d0                	and    %dl,%al
 a6f:	74 0a                	je     a7b <uthread_yield+0x8b>
      current_ticket_num += uthread_pool[j].ntickets;
 a71:	8b 7e 04             	mov    0x4(%esi),%edi
 a74:	88 45 e7             	mov    %al,-0x19(%ebp)
 a77:	01 cf                	add    %ecx,%edi
 a79:	89 f9                	mov    %edi,%ecx
 a7b:	83 c6 18             	add    $0x18,%esi
  // ************** lottery scheduler mechanism ******************* //
  ...
  current_ticket_num = -1;
  for(j = 0; j < MAX_THREADS; ++j) {
 a7e:	81 fe 98 19 00 00    	cmp    $0x1998,%esi
 a84:	75 da                	jne    a60 <uthread_yield+0x70>
 a86:	80 7d e7 00          	cmpb   $0x0,-0x19(%ebp)
 a8a:	0f 85 ec 00 00 00    	jne    b7c <uthread_yield+0x18c>
...
rand()
{
 ...
 a90:	69 05 80 14 00 00 0d 	imul   $0x19660d,0x1480,%eax
 a97:	66 19 00 
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
...
{
  randstate = randstate * 1664525 + 1013904223;
 aa7:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 aac:	a3 80 14 00 00       	mov    %eax,0x1480
    if(uthread_pool[j].state != FREE && uthread_pool[j].state != SLEEP)
      current_ticket_num += uthread_pool[j].ntickets;
  }
  ...
  randomTicket = rand() % current_ticket_num;
 ab1:	f7 f1                	div    %ecx
 ab3:	89 d6                	mov    %edx,%esi

  printf(1,"current_ticket_num=%d\n", current_ticket_num);
 ab5:	e8 16 fc ff ff       	call   6d0 <printf>
  printf(1,"randomTicket=%d\n", randomTicket);
 aba:	83 c4 0c             	add    $0xc,%esp
 abd:	56                   	push   %esi
 abe:	68 34 0f 00 00       	push   $0xf34
 ac3:	6a 01                	push   $0x1
 ac5:	e8 06 fc ff ff       	call   6d0 <printf>

  // set the choosen order thread to run
  choosen = randomTicket / NTICKET;
 aca:	89 f0                	mov    %esi,%eax
 acc:	ba 67 66 66 66       	mov    $0x66666667,%edx
 ad1:	c1 fe 1f             	sar    $0x1f,%esi
 ad4:	f7 ea                	imul   %edx
 ad6:	83 c4 10             	add    $0x10,%esp

  // pick the index of choosen thread
  int chooseCount = -1;
 ad9:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
  for(j = 0; j < MAX_THREADS; ++j) {
 ade:	31 c0                	xor    %eax,%eax
  ...
  choosen = randomTicket / NTICKET;
 ae0:	d1 fa                	sar    %edx
 ae2:	29 f2                	sub    %esi,%edx
 ae4:	89 15 8c 19 00 00    	mov    %edx,0x198c
 aea:	eb 0f                	jmp    afb <uthread_yield+0x10b>
 ...
 af3:	83 c3 18             	add    $0x18,%ebx
 af6:	83 f8 07             	cmp    $0x7,%eax
 af9:	74 15                	je     b10 <uthread_yield+0x120>
    if(uthread_pool[j].state == RUNNABLE) {
 afb:	83 3b 02             	cmpl   $0x2,(%ebx)
 afe:	75 f0                	jne    af0 <uthread_yield+0x100>
      chooseCount++;
 b00:	83 c1 01             	add    $0x1,%ecx
      if (choosen == chooseCount)
 b03:	39 ca                	cmp    %ecx,%edx
 b05:	75 e9                	jne    af0 <uthread_yield+0x100>
 ...
 b09:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  ...
  c_uthread_index = j;
 b10:	a3 c0 18 00 00       	mov    %eax,0x18c0
 ...
 b18:	8d 04 c5 e0 18 00 00 	lea    0x18e0(,%eax,8),%eax
 ...
 b50:	89 d4                	mov    %edx,%esp
    asm("movl %0, %%ebp;" : : "r" (uthread_pool[c_uthread_index].ebp));
 b52:	8b 40 08             	mov    0x8(%eax),%eax
 ...
 b5a:	6a 05                	push   $0x5
 b5c:	e8 b9 fa ff ff       	call   61a <alarm>
 ...
 b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if (uthread_pool[c_uthread_index].state == RUNNING) {
    uthread_pool[c_uthread_index].state = RUNNABLE;
 b70:	c7 42 10 02 00 00 00 	movl   $0x2,0x10(%edx)
 b77:	e9 a0 fe ff ff       	jmp    a1c <uthread_yield+0x2c>
 b7c:	89 3d 90 19 00 00    	mov    %edi,0x1990
 b82:	e9 09 ff ff ff       	jmp    a90 <uthread_yield+0xa0>
...
{
  randstate = randstate * 1664525 + 1013904223;
 b90:	69 05 80 14 00 00 0d 	imul   $0x19660d,0x1480,%eax
 b97:	66 19 00 
//***************************************************************************************//
...
{
  randstate = randstate * 1664525 + 1013904223;
 b9e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
 ba3:	a3 80 14 00 00       	mov    %eax,0x1480
  return randstate;
}
 ba8:	c3                   	ret    
 ba9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

00000bb0 <uthread_init>:
  uthread_exit();
}
 ...
 uthread_init()
{
 ...
 bb6:	68 45 0f 00 00       	push   $0xf45
 bbb:	6a 01                	push   $0x1
 bbd:	e8 0e fb ff ff       	call   6d0 <printf>
 bc2:	b8 f0 18 00 00       	mov    $0x18f0,%eax
 ...
 bd0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    uthread_pool[i].ntickets = NTICKET;
 bd6:	c7 40 04 05 00 00 00 	movl   $0x5,0x4(%eax)
 bdd:	83 c0 18             	add    $0x18,%eax
 uthread_init()
{
  printf(1, "** INIT USER LEVEL THREAD **\n");
  // set all threads state to FREE - init pool
  int i;
  for(i = 0; i < MAX_THREADS; ++i) {
 be0:	3d 98 19 00 00       	cmp    $0x1998,%eax
 be5:	75 e9                	jne    bd0 <uthread_init+0x20>
 ...
 be7:	83 ec 08             	sub    $0x8,%esp
  ...
  next_tid = 1;
 bea:	c7 05 88 19 00 00 01 	movl   $0x1,0x1988
 bf1:	00 00 00 

  // initialize main thread
  c_uthread_index = 0;
 bf4:	c7 05 c0 18 00 00 00 	movl   $0x0,0x18c0
 bfb:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 ...
 c05:	c7 05 e0 18 00 00 00 	movl   $0x0,0x18e0
 c0c:	00 00 00 
  uthread_pool[c_uthread_index].stack = 0; 
 c0f:	c7 05 ec 18 00 00 00 	movl   $0x0,0x18ec
 c16:	00 00 00 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
 c19:	c7 05 f0 18 00 00 01 	movl   $0x1,0x18f0
 c20:	00 00 00 

  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 c23:	e8 da f9 ff ff       	call   602 <signal>
 c28:	83 c4 10             	add    $0x10,%esp
 c2b:	85 c0                	test   %eax,%eax
    // case signal error
    return -1;
 c2d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  uthread_pool[c_uthread_index].stack = 0; 
  // main thread is ready to run
  uthread_pool[c_uthread_index].state = RUNNING;
  ...
  // register the SIGALRM to uthread_yield func
  if(signal(SIGALRM, uthread_yield) != 0) {
 c32:	75 0f                	jne    c43 <uthread_init+0x93>
    // case signal error
    return -1;
  }
...
uthread_create(void (*func)(void *), void* arg)
{
 ...
 c58:	68 63 0f 00 00       	push   $0xf63
 c5d:	6a 01                	push   $0x1
 c5f:	e8 6c fa ff ff       	call   6d0 <printf>
  ...
  alarm(0);
 c64:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
 c6b:	e8 aa f9 ff ff       	call   61a <alarm>

  printf(1, "uthread_create after alarm(0) \n");
 c70:	5b                   	pop    %ebx
 c71:	5e                   	pop    %esi
 c72:	68 90 0f 00 00       	push   $0xf90
 c77:	6a 01                	push   $0x1
 c79:	e8 52 fa ff ff       	call   6d0 <printf>
 c7e:	ba f0 18 00 00       	mov    $0x18f0,%edx
 ...
 c92:	85 c9                	test   %ecx,%ecx
 c94:	74 2a                	je     cc0 <uthread_create+0x70>
  alarm(0);
 ...
 c99:	83 c2 18             	add    $0x18,%edx
 c9c:	83 f8 07             	cmp    $0x7,%eax
 c9f:	75 ef                	jne    c90 <uthread_create+0x40>
    }
  }
 ...
 ca4:	6a 05                	push   $0x5
 ca6:	e8 6f f9 ff ff       	call   61a <alarm>
  return -1;
 ...
 cae:	8d 65 f8             	lea    -0x8(%ebp),%esp
  ...
  alarm(UTHREAD_QUANTA);
  return -1;
 cb1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  // enable thread switching
  printf(1, "creation method: returning.. \n");
  alarm(UTHREAD_QUANTA);
...
load_t:
 ...
 cc0:	8b 15 88 19 00 00    	mov    0x1988,%edx
 cc6:	8d 1c 40             	lea    (%eax,%eax,2),%ebx
  // update next tid
  next_tid++;
 ...
 ccc:	68 00 10 00 00       	push   $0x1000
  alarm(UTHREAD_QUANTA);
  return -1;
...
load_t:
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
 cd1:	c1 e3 03             	shl    $0x3,%ebx
 cd4:	89 93 e0 18 00 00    	mov    %edx,0x18e0(%ebx)
  // update next tid
  next_tid++;
 cda:	83 c2 01             	add    $0x1,%edx
 cdd:	89 15 88 19 00 00    	mov    %edx,0x1988
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 ce3:	e8 18 fc ff ff       	call   900 <malloc>
 ...
 ce8:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  // load thread execute function to stack with arguments and return value
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
 ceb:	c7 80 f4 0f 00 00 00 	movl   $0x0,0xff4(%eax)
 cf2:	00 00 00 
  // next free tid to assign
  uthread_pool[i].tid = next_tid;
  // update next tid
  ...
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
 cf5:	89 83 ec 18 00 00    	mov    %eax,0x18ec(%ebx)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 ...
 cfb:	c7 83 f0 18 00 00 02 	movl   $0x2,0x18f0(%ebx)
 d02:	00 00 00 

  // set esp and ebp to null, while thread is not in RUNNING state yet
  uthread_pool[i].esp = 0;
 d05:	c7 83 e4 18 00 00 00 	movl   $0x0,0x18e4(%ebx)
 d0c:	00 00 00 
  uthread_pool[i].ebp = 0;
 d0f:	c7 83 e8 18 00 00 00 	movl   $0x0,0x18e8(%ebx)
 d16:	00 00 00 
  // allocate stack for thread and returns the stack top to .stack field
  uthread_pool[i].stack = malloc(STACK_SIZE);
  ...
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 3*sizeof(int)) ) = 0; 
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - 2*sizeof(int)) ) = (int)func;
 d19:	89 90 f8 0f 00 00    	mov    %edx,0xff8(%eax)
  *( (int*)(uthread_pool[i].stack + STACK_SIZE - sizeof(int)) ) = (int)arg;
 d1f:	8b 55 0c             	mov    0xc(%ebp),%edx
 d22:	89 90 fc 0f 00 00    	mov    %edx,0xffc(%eax)
  uthread_pool[i].esp = 0;
  uthread_pool[i].ebp = 0;
 ...
 d28:	58                   	pop    %eax
 d29:	5a                   	pop    %edx
 d2a:	68 b0 0f 00 00       	push   $0xfb0
 d2f:	6a 01                	push   $0x1
 d31:	e8 9a f9 ff ff       	call   6d0 <printf>
  alarm(UTHREAD_QUANTA);
 d36:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 d3d:	e8 d8 f8 ff ff       	call   61a <alarm>

  return uthread_pool[i].tid;
 d42:	8b 83 e0 18 00 00    	mov    0x18e0(%ebx),%eax
 d48:	83 c4 10             	add    $0x10,%esp
}
 d4b:	8d 65 f8             	lea    -0x8(%ebp),%esp
 d4e:	5b                   	pop    %ebx
 d4f:	5e                   	pop    %esi
 d50:	5d                   	pop    %ebp
 d51:	c3                   	ret    
...
uthread_exit(void)
{
 ...
 d64:	83 ec 10             	sub    $0x10,%esp
  ...
  alarm(0);
 d67:	6a 00                	push   $0x0
 d69:	e8 ac f8 ff ff       	call   61a <alarm>

  // deallocate thread memory
  if (uthread_pool[c_uthread_index].stack != 0) {
 d6e:	a1 c0 18 00 00       	mov    0x18c0,%eax
 d73:	83 c4 10             	add    $0x10,%esp
 d76:	8d 14 40             	lea    (%eax,%eax,2),%edx
 d79:	8b 14 d5 ec 18 00 00 	mov    0x18ec(,%edx,8),%edx
 d80:	85 d2                	test   %edx,%edx
 d82:	74 11                	je     d95 <uthread_exit+0x35>
    free(uthread_pool[c_uthread_index].stack);
 d84:	83 ec 0c             	sub    $0xc,%esp
 d87:	52                   	push   %edx
 d88:	e8 e3 fa ff ff       	call   870 <free>
 d8d:	a1 c0 18 00 00       	mov    0x18c0,%eax
 d92:	83 c4 10             	add    $0x10,%esp
  }

  // deallocate thread from thread pool
  uthread_pool[c_uthread_index].state = FREE;
 d95:	8d 04 40             	lea    (%eax,%eax,2),%eax
 d98:	bb f0 18 00 00       	mov    $0x18f0,%ebx
 d9d:	c7 04 c5 f0 18 00 00 	movl   $0x0,0x18f0(,%eax,8)
 da4:	00 00 00 00 
 da8:	89 d8                	mov    %ebx,%eax
 daa:	eb 0e                	jmp    dba <uthread_exit+0x5a>
 dac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 db0:	83 c0 18             	add    $0x18,%eax

  // if any thread is waiting for current thread, get them back to RUNNABLE state
  for(i = 0; i < MAX_THREADS; ++i) {
 db3:	3d 98 19 00 00       	cmp    $0x1998,%eax
 db8:	74 26                	je     de0 <uthread_exit+0x80>
    if (uthread_pool[i].state == SLEEP) {
 dba:	83 38 03             	cmpl   $0x3,(%eax)
 dbd:	75 f1                	jne    db0 <uthread_exit+0x50>
      uthread_pool[i].state = RUNNABLE;
 dbf:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
 dc5:	eb e9                	jmp    db0 <uthread_exit+0x50>
 dc7:	89 f6                	mov    %esi,%esi
 dc9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 dd0:	83 c3 18             	add    $0x18,%ebx
  ...
  for(i = 0; i < MAX_THREADS; ++i) {
    if (uthread_pool[i].state != FREE) {
      ...
      uthread_yield();
 dd3:	e8 18 fc ff ff       	call   9f0 <uthread_yield>
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 dd8:	81 fb 98 19 00 00    	cmp    $0x1998,%ebx
 dde:	74 11                	je     df1 <uthread_exit+0x91>
    if (uthread_pool[i].state != FREE) {
 de0:	8b 03                	mov    (%ebx),%eax
 de2:	85 c0                	test   %eax,%eax
 de4:	75 ea                	jne    dd0 <uthread_exit+0x70>
 de6:	83 c3 18             	add    $0x18,%ebx
      uthread_pool[i].state = RUNNABLE;
    }
  }
  ...
  // Check if there are any other uthread_pool that can be switched to
  for(i = 0; i < MAX_THREADS; ++i) {
 de9:	81 fb 98 19 00 00    	cmp    $0x1998,%ebx
 def:	75 ef                	jne    de0 <uthread_exit+0x80>
      // found thread that is eligible to run, yield
      uthread_yield();
    }
  }
...
execute_thread(void (*start_func)(void *), void* arg) {
 ...
 e03:	83 ec 10             	sub    $0x10,%esp
  printf(1, "+++RUN THREAD+++ \n");
 e06:	68 7b 0f 00 00       	push   $0xf7b
 e0b:	6a 01                	push   $0x1
 e0d:	e8 be f8 ff ff       	call   6d0 <printf>
  alarm(UTHREAD_QUANTA);
 e12:	c7 04 24 05 00 00 00 	movl   $0x5,(%esp)
 e19:	e8 fc f7 ff ff       	call   61a <alarm>
  start_func(arg);
 e1e:	58                   	pop    %eax
 e1f:	ff 75 0c             	pushl  0xc(%ebp)
 e22:	ff 55 08             	call   *0x8(%ebp)
  uthread_exit();
 e25:	e8 36 ff ff ff       	call   d60 <uthread_exit>
 e2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

00000e30 <uthred_self>:
...
uthred_self(void)
{
 ...
 e30:	a1 c0 18 00 00       	mov    0x18c0,%eax
  }
}
...
uthred_self(void)
{
 ...
 e36:	89 e5                	mov    %esp,%ebp
  // return current running thread tid
  return uthread_pool[c_uthread_index].tid;
 e38:	8d 04 40             	lea    (%eax,%eax,2),%eax
}
 e3b:	5d                   	pop    %ebp
...
loop:
 ...
 e6e:	6a 00                	push   $0x0
 e70:	e8 a5 f7 ff ff       	call   61a <alarm>
 e75:	b8 e0 18 00 00       	mov    $0x18e0,%eax
 ...
 e80:	3b 18                	cmp    (%eax),%ebx
 e82:	74 24                	je     ea8 <uthred_join+0x58>
 e84:	83 c0 18             	add    $0x18,%eax
  ...
  // run over all threads
  for(i = 0; i < MAX_THREADS; ++i) {
 e87:	3d 88 19 00 00       	cmp    $0x1988,%eax
 e8c:	75 f2                	jne    e80 <uthred_join+0x30>
 ...
 e91:	6a 05                	push   $0x5
 e93:	e8 82 f7 ff ff       	call   61a <alarm>

  return 0;
 e98:	83 c4 10             	add    $0x10,%esp
 e9b:	31 c0                	xor    %eax,%eax
}
 ...
 ea8:	a1 c0 18 00 00       	mov    0x18c0,%eax
 ead:	8d 04 40             	lea    (%eax,%eax,2),%eax
 eb0:	c7 04 c5 f0 18 00 00 	movl   $0x3,0x18f0(,%eax,8)
 eb7:	03 00 00 00 
      // let other thread to run 
      uthread_yield();
 ebb:	e8 30 fb ff ff       	call   9f0 <uthread_yield>

      // if thread still alive, loop over the join procedure again
      goto loop;
 ec0:	eb a9                	jmp    e6b <uthred_join+0x1b>
{
  int i;
 ...
 ec7:	eb d4                	jmp    e9d <uthred_join+0x4d>
